...
while ($myrowsel_main = array_shift($result_crm)) {
    ...
    $po_ponumber = "";
    db();
    $result_n = db_query("Select po_ponumber from loop_transaction_buyer where id = " . $_REQUEST["rec_id"]);
    while ($myrowsel_n = array_shift($result_n)) {
    ...
    $eml_confirmation .= "<tr><td style=\"width:100%%;font-family: 'Montserrat', 'Helvetica Neue', Helvetica, Arial, 'sans-serif';font-size:16pt;color:#a6a6a6;\"><br><span style=\"font-size:12pt;color:#a6a6a6;\" >ORDER #" . $_REQUEST["rec_id"] . " (PO " . $pono . ") </span><br><br><div style=\"width:100%;font-family: 'Montserrat', 'Helvetica Neue', Helvetica, Arial, 'sans-serif';font-size:19pt;color:#000000;\" >Carrier selected for shipping your purchase</div></td></tr>";

    $eml_confirmation .= "<tr><td><br><div style=\"font-family: 'Montserrat', 'Helvetica Neue', Helvetica, Arial, 'sans-serif';font-size:12pt;color:#767171; margin-top:3px;\"><p>We have selected " . $fr_contact . " at " . $fr_name . " to pick up and deliver your order.	</p></div></td></tr>";
    $eml_confirmation .= "<tr><td><br><div style=\"font-family: 'Montserrat', 'Helvetica Neue', Helvetica, Arial, 'sans-serif';font-size:12pt;color:#767171; margin-top:3px;\"><p> " . $fr_contact . " is copied on this email and will be reaching out to you to schedule a dock appointment, day and time for delivery.</p></div></td></tr>";
...
<form name="email_reminder_sch_p3" id="email_reminder_sch_p3" action="sendemail_freight_booking_save.php" method="post">
    <div align="right">
    ...
    <table>
        <tr>
            ...
            <td width="90%"> <input size=60 type="text" id="txtemailto" name="txtemailto"
                    value="<?php echo $myrowsel_main["shipemail"]; ?>;<?php echo $fr_eml; ?>"></td>
        </tr>

        <tr>
            <td width="10%">Cc:</td>
            <td width="90%"> <input size=60 type="text" id="txtemailcc" name="txtemailcc"
                    value="<?php echo $acc_owner_eml; ?> <?php if ($myrowsel_main["shipemail"] != $sellto_eml) {
                                                                                                                                        echo ";" . $sellto_eml;
        ...
        <tr>
            ...
            <td width="90%"><input size=90 type="text" id="txtemailsubject" name="txtemailsubject"
                    value="UsedCardboardBoxes Order #<?php echo $_REQUEST["rec_id"]; ?> Has Freight Assigned"></td>
        </tr>
