...
?>
<div id="wrapper">
    <?php require_once("inc/sidebar_new_dashboard.php"); ?>
        ...
        <div id="content">
            <div class="container-fluid py-3  create_meeting" id="create_meeting_main">
                ...
                <div class="row justify-content-center">
                    <?php if (isset($_GET['from_meet']) && $_GET['from_meet'] == "yes") { ?>
                    ...
                    <div class="col-md-3">
                        <div class="card shadow mb-4 px-4 pt-4">
                            ...
                            if ($meeting_id == "") {
                                ...
                                db_project_mgmt();
                                $sql_main = db_query("SELECT meeting_name FROM meeting_master where id=$meeting_id");
                        ...
                        <div class="text-center" id="launch_meeting_btn">
                            ...
                            if ($meeting_id != "") {
                                db_project_mgmt();
                                $meeting_flg_qry = db_query("SELECT mt.meeting_id,mt.id,mt.meeting_flg from meeting_timer as mt where meeting_id=$meeting_id ORDER BY id DESC limit 1");
                                $meeting_flg = 1;
                            ...
                            ?>
                                        ...
                                        <?php } else { ?>
                                            <a href="launch_meeting.php?meeting_id=<?php echo $m_id; ?>" onclick="return check_meeting_saved()" class="btn btn-blue w-75"><i class="fa fa-play-circle"></i> Launch Meeting</a>
                                    <?php }
                                    }
                                } else { ?>
                                    <a href="launch_meeting.php?meeting_id=<?php echo $m_id; ?>" onclick="return check_meeting_saved()" class="btn btn-blue w-75"><i class="fa fa-play-circle"></i> Launch Meeting</a>
                        ...
                        <div class="text-left">
                            <ul class="meeting_create_left_side">
                                ...
                                <li><i class="fa fa-clock-o"></i> <a onclick="return check_meeting_saved()" href="meeting_minutes.php?meeting_id=<?php echo $_GET['meeting_id']; ?>">Meeting Minutes</a></li>
                                <li><i class="fa fa-paper-plane"></i> <a href="meeting_vto.php?meeting_id=<?php echo $_GET['meeting_id']; ?>">View Meeting VTO</a></li>
                                                ...
                                                <form action="" method="post" class="meeting_form">
                                                    <div class="form-group row my-5">
                                                        ...
                                                        <div class="col-md-9">
                                                            ...
                                                            <div class="mt-2 col-md-12 alert alert-success <?php echo isset($_GET['meet_create']) && $_GET['meet_create'] == 1 ? '' : 'd-none'; ?>" id="meeting_action_msg">
                                                            ...
                                                            <div class="d-flex mt-4">
                                                                ...
                                                                <button type="button" id="save-meeting-name" class="btn btn-blue btn-sm <?php echo isset($_GET['meet_create']) && $_GET['meet_create'] == 1 ? 'd-none' : ''; ?>"><?php echo $meeting_save_text; ?></button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </form>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <?php  } else {
                                                    db_project_mgmt();
                                                    $sql_main = db_query("SELECT ma.attendee_id  FROM meeting_attendees as ma where ma.meeting_id=$meeting_id ORDER BY attendee_id ASC");
                                                    $no_data_div = "d-none";
                                                ...
                                                ?>
                                                    <table id="meetingCreateAttendeesList" class="table table-sm meetingTable mt-3 table_vetical_align_middle hover_table border-0  <?php echo $present_data_div; ?>">
                                                        ...
                                                        while ($hrow = array_shift($sql_main)) {
                                                            db();
                                                            $empDetails_qry = db_query("SELECT Headshot, name,initials from loop_employees where b2b_id='" . $hrow['attendee_id'] . "'");
                                                        ...
                                                        <table id="metricsTable" class="table table-sm meetingTable table_vetical_align_middle hover_table mt-5 border-0">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                while ($scorecard_data = array_shift($scorecard_data_query)) {
                                                                    db();
                                                                    $empDetails_qry = db_query("SELECT Headshot, name,initials from loop_employees where b2b_id='" . $scorecard_data['accountable'] . "'");
                                                                    $empDetails_arr = array_shift($empDetails_qry);
                                                                    $empDetails = getOwerHeadshotForMeeting($empDetails_arr['Headshot'], $empDetails_arr['initials']);
                                                                ...
                                                                ?>
                                                                    <tr data-sort-id="<?php echo new_dash_encrypt($scorecard_data['id']) ?>">
                                                                        <td><i class="fa fa-arrows"></i></td>
                                                                        <td class="matrix_image">
                                                                            <span class="attendees_img" style="background-image:url('<?php echo $empDetails['emp_img'] ?>')">
                                                                                <?php echo $empDetails['emp_txt']; ?></span>
                                                                        </td>
                                                                        <td class="td_w_60 matrix_name">
                                                                            <a type="button" class="" data-toggle="modal" data-target="#scorecardAddMatrixModalPopop" data-whatever="<?php echo new_dash_encrypt($scorecard_data['id']) ?>" data-todo='{"EditingFrom":"EditMeetingMatrix"}'><?php echo $scorecard_data['name'] ?>
                                                                            </a>
                                                                        </td>
                                                                        <td class="matrix_goal">
                                                                            <a type="button" class="" data-toggle="modal" data-target="#scorecardAddMatrixModalPopop" data-whatever="<?php echo new_dash_encrypt($scorecard_data['id']) ?>" data-todo='{"EditingFrom":"EditMeetingMatrix"}'><?php echo $goal ?>
                                                                            </a>
                                                                        </td>
                                                                        <td class="td_w_15 matrix_goal_matrix">
                                                                            <a type="button" class="" data-toggle="modal" data-target="#scorecardAddMatrixModalPopop" data-whatever="<?php echo new_dash_encrypt($scorecard_data['id']) ?>" data-todo='{"EditingFrom":"EditMeetingMatrix"}'><?php echo $scorecard_data['goal_matric'] ?>
                                                                            </a>
                                                                        </td>
                                                                        <td>
                                                                            <a href="javascript:void(0)" id='deleteMatrix' onclick="deleteMatrix($(this),'<?php echo new_dash_encrypt($scorecard_data['id']) ?>')">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 mt-3" id="meetingTaskDiv">
                                                ...
                                                <?php } else {
													...
													where task_meeting=$meeting_id and archive_status=0 ORDER BY id DESC");
                                                    $no_data_div = "d-none";
                                                    $present_data_div = "d-table";
                                                        ...
                                                        <tbody>
                                                            ...
                                                            ?>
                                                                <tr>
                                                                    <td><span class="attendees_img" style="background-image:url('<?php echo $empDetails['emp_img']; ?>')"><?php echo $empDetails['emp_txt']; ?></span><span class="sr-only"><?php echo $r['name']; ?></span></td>
                                                                    <td class="td_w_95">
                                                                        <a class="edit_title_all" <?php echo $r['task_status'] == 2 || $r['task_status'] == 1 ? "style='text-decoration:line-through'" : ""; ?> href="javascript:edit_task(<?php echo $r['id']; ?>,'EDIT_TASK_MEETING')"><?php echo $r['task_title']; ?></a>
                                                                    </td>
                                                                    <!--<td><input type="checkbox" class="checkbox_lg"/></td> -->
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 mt-3" id="meetingIssueDiv">
                                                ...
                                                <?php } else {
                                                    db_project_mgmt();
                                                    $issue_sql = db_query("SELECT issue_master.id,issue,created_by FROM issue_master where meeting_id=$meeting_id and issue_master.status = 1 ORDER BY id DESC");
                                                    $no_data_div = "d-none";
                                                    $present_data_div = "d-table";
                ...
                if (delMatrixID) {
                    $.ajax({
                        ...
                        data: {
                            ...
                            'meetingID': '<?php echo isset($meeting_id) && $meeting_id != '' ? $meeting_id : 0 ?>'
                        },
                        success: function(response) {
