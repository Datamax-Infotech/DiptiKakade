    ...
    <div class="col-md-2">
        <div class="card shadow meeting_timer text-center">
            <div class="card-body p-3">
                ...
                $selres1 = db_query($selsql1);
                $meeting_owner = ""; $st_dtime = ""; $recid = "";
                if (tep_db_num_rows($selres1) > 0) {
                    ...
                    if ($rowdata["meeting_flg"] == 1) {
                        ...
                        $check_attendee_join_status = db_query("SELECT join_status from meeting_start_atten_ratings where meeting_timer_id=$meeting_timer_id && attendee_id=" . $_COOKIE['b2b_id'] . " && join_status=1");
                ...
                <input type="hidden" id="server-timestamp" value="<?php echo date("Y-m-d H:i:s"); ?>">
                <input type="hidden" id="meeting_timerid" value="<?php echo $recid; ?>">
                <script>
                    ...
                    startMeetingTimer('<?php echo $st_dtime; ?>', '<?php echo $duration; ?>');
                </script>
            </div>
        </div>
    ...
    <h4 class="mb-0">Tangent Alert</h4>
        ...
        <div class="card shadow mb-3 px-3 py-2 agenda mt-4 ">
            <h6 class="mb-0 mt-2">
                ...
                <div class="float-right dropdown dropright agenda_setting_dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right ">
                        <a class="dropdown-item" href="dashboard_meeting_create.php?meeting_id=<?php echo  $_GET['meeting_id']; ?>&&from_meet=yes"><i class="fa fa-pencil"></i> Edit Meeting</a>
                        <div class="dropdown-divider my-1"></div>
                        <!--<a class="dropdown-item" href="javascript:void(0)"><i class="fa fa-trash-o"></i>  Meeting Archive</a>-->
                        <a class="dropdown-item" href="meeting_minutes.php?meeting_id=<?php echo  $_GET['meeting_id']; ?>"><i class="fa fa-clock-o"></i> Meeting Minutes</a>
            ...
            <div class="card-body px-0 py-2">
                ...
                $sql_main = db_query("SELECT * FROM meeting_pages where meeting_id=$meeting_id ORDER BY order_no ASC");
                if (tep_db_num_rows($sql_main) > 0) {
                    $current_page_of_owner_sql = db_query("SELECT current_page from meeting_live_updates where meeting_timer_id='" . $meeting_timer_id . "' && attendee_id=" . $meeting_owner);
                ...
                ?>
                    <ul class="p-0">
                        ...
                        while ($hrow = array_shift($sql_main)) {
                            $select_time = db_query("SELECT id,time_spent from meeting_time_spent where meeting_timer_id='" . $meeting_timer_id . "' && page_id=" . $hrow['page_id']);
        ...
        <div class="card shadow mb-3 px-3 py-2">
            <a class="meeting_sidebar_link" href="meeting_vto.php?meeting_id=<?php echo  $_GET['meeting_id']; ?>&meeting_timer_id=<?php echo $_GET['meeting_timer_id']; ?>">Meeting VTO <span class="float-right"><i class="fa fa-angle-right fa-lg"></i></span></a>
        </div>
        <!--<div class="card shadow mb-3 px-3 py-2">
        <a class="meeting_sidebar_link" href="company_vto.php?meeting_id=<?php echo  $_GET['meeting_id']; ?>&meeting_timer_id=<?php echo $_GET['meeting_timer_id']; ?>">Company VTO <span class="float-right"><i class="fa fa-angle-right fa-lg"></i></span></a>
    </div> -->
        <div class="card shadow mb-3 px-3 py-2">
        ...
        <div class="accordion" id="accordionExample">
            <div class="card shadow mb-3 px-3 py-2">
                ...
                <a class="meeting_sidebar_link" href="javascript:void(0)" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">Online(<span id="online_attendee_count"><?php echo  count($res); ?></span>) <span class="float-right"><i class="fa fa-angle-right fa-lg"></i></span></a>
                <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample">
                    <div class="card-body px-0 py-2" id="online_attendees">
                        ...
                        db_project_mgmt();
                        db_query("UPDATE meeting_live_updates set attendee_flg = 0 where meeting_timer_id='" .$meeting_timer_id. "' && attendee_id=" .$_COOKIE['b2b_id']);
                        ?>
                    </div>
                </div>
            </div>
