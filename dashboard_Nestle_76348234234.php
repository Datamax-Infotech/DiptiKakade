...
<head>
    ...
    <title>Nestle - Solon - Dashboard</title>
...
<body>
        ...
        <tr>
            <td valign="top">
                ...
                <FORM METHOD="POST" ACTION="BOLpickupsubmitNEW.php">
                    ...
                    <input type=hidden value="dashboard_Nestle_76348234234.php" name="return_url">
                    <?php
                    ...
                    <TABLE ALIGN='LEFT' width="450">
                        ...
                        <TR>
                            ...
                            <TD bgColor="#e4e4e4" class="style12" CLASS='TBL_ROW_HDR' style="text-align: left">
                                <font size="2" face="Arial">
                                    Gaylord Boxes<input type="hidden" name="item_1" value="Pallets of Boxes">
                                </font>
                            </TD>
                        </TR>
                        <TR>
                            ...
                            <TD bgColor="#e4e4e4" class="style12" CLASS='TBL_ROW_HDR' style="text-align: left">
                                <font size="2" face="Arial">
                                    <input type=text size="55"
                                        value="Other: Check box &amp; replace text with item description" name="item_2">
                                </font>
                            </TD>
                        </TR>
                        <TR>
                            ...
                            <TD bgColor="#e4e4e4" class="style12" CLASS='TBL_ROW_HDR' style="text-align: left">
                                <font size="2" face="Arial">
                                    <input type=text size="55"
                                        value="Other: Check box &amp; replace text with item description" name="item_3">
                                </font>
                            </TD>
                        </TR>
                        <TR>
            ...
            <td valign="top">
                ...
                <table cellSpacing="1" cellPadding="1" border="0">
                    ...
                    <?php
                    $query = "SELECT * FROM loop_transaction WHERE warehouse_id = " . $warehouse_id . " AND pa_employee LIKE '' AND cp_employee LIKE '' ORDER BY ID ASC";
                    db();
                    $res = db_query($query);
                    while ($row = array_shift($res)) {
    ...
    <table cellSpacing="1" cellPadding="1" border="0">
        ...
        <?php
        $query = "SELECT * FROM loop_transaction WHERE warehouse_id = " . $warehouse_id . " AND (pa_employee NOT LIKE '' OR bol_employee NOT LIKE '') AND sort_entered = 0 ORDER BY ID ASC";
        db();
        $res = db_query($query);
        while ($row = array_shift($res)) {
        ...
        <tr>
            <td>
                ...
                <table cellSpacing="1" cellPadding="1" width="550" border="0">
                    ...
                    <?php
                        $query = "SELECT * FROM loop_transaction WHERE warehouse_id = " . $warehouse_id . " AND";
