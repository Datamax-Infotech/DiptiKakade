<?php session_start();
            ...
            <div class="container-fluid p-0 create_meeting mt-0" >
                <div class="card py-3 px-4">
                    <div class="row align-items-center">
                        ...
                        ?>
                        <div class="col-md-9">
                            <h3>Meeting Minutes: <small><?php echo $meeting_name; ?></small></h3>
    ...
    function loadMeetingMinutesTable(){
        ...
        xhttp.open("GET", "meeting_minutes_action.php?status=getCollapseTable&meeting_id=<?php echo$meeting_id?>", true);
        xhttp.send();
    }

    if("<?php echo $meeting_id !=""?>") window.onload = loadMeetingMinutesTable();
