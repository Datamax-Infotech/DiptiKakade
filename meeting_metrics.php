                                                        ...
                                                        while ($scorecard_data = array_shift($scorecard_data_query)) {
                                                            ...
                                                            <tr data-sort-id="<?php echo new_dash_encrypt($scorecard_weeks_id) ?>">
                                                                ...
                                                                <td class="matrics_attandees_img"><span class="attendees_img"
                                                                        style="background-image:url('<?php echo $scorecardUserImage ?>')">
                                                                        <?php echo $scorecardUserText ?>
                                                                    </span></td>
                                                                <td class="td-border-bottom matrics_mesurable_name text-left">
                                                                    <a id="measurableModal" type="button" class=""
                                                                        ...
                                                                        data-whatever="<?php echo new_dash_encrypt($scorecard_weeks_id) ?>"
                                                                        data-todo='{"EditingFrom":"meetingStartMatrix"}'>
                                                                        <?php echo $scorecard_data['name'] ?>
                                                                    </a>
                                                                </td>
                                                                    ...
                                                                    foreach ($scorecardweeks_for_thead as $week) {
                                                                        ...
                                                                        if (!empty($inner_scorecard_data_query)) {
                                                                            while ($inner_scorecard_data = array_shift($inner_scorecard_data_query)) {
                                                                                ...
                                                                                ?>
                                                                                <td
                                                                                    class="measurable_val_td <?php echo $putValue == true ? $box_color : '' ?>">
                                                                                    <input type="text" class="edit_content text-center"
                                                                                        onblur="<?php echo $onblur ?>" onkeyup="matrixvalidateInput(this)"
                                                                                        value="<?php echo $putValue == true ? $inputValue : '' ?>" />
                                                                                    <input type="hidden" class="tdweek"
                                                                                        value="<?php echo str_replace('<br>', " to ", $week); ?>">
                                                                                </td>
                                                                            <?php
                                                                            }
                                                                        } else {
                                                                ...
                                                                <input type="hidden" class="trID"
                                                                    value="<?php echo new_dash_encrypt($scorecard_data['id']) ?>">
                                                            </tr>
                                                        <?php
                                                        }
                                                        ?>
                ...
                $('#meetingMetricsTable tbody').sortable({
                    ...
                    update: function () {
                        ...
                        $.post(
                            ...
                            { 'matircs_sort_action': 'matricsTableOrdering', 'sortOrder': sortOrder, 'meetingTimerID': '<?php echo isset($_GET['meeting_timer_id']) ? $_GET['meeting_timer_id'] : 0 ?>' },
                            function (data) {
                                //console.log(data);
                                if (data == 1) {
