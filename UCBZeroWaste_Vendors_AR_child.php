...
<table width="60%" border="0" cellspacing="1" cellpadding="1">
        ...
        <td width="290px">Vendor Name&nbsp;
            <a href="javascript:void();"
                onclick="displarepsorteddata('<?php echo $comp_sel; ?>','<?php echo $vendors_dd; ?>','<?php echo $ddMadePayment; ?>', '<?php echo $date_from; ?>', '<?php echo $date_to; ?>', '<?php echo $receivables; ?>', '<?php echo $payables; ?>', 1, 1);"><img
                    src="images/sort_asc.png" width="5px;" height="10px;"></a>&nbsp;<a href="javascript:void();"
    ...
    <tr>
        ...
        <td bgcolor="<?php echo isset($bgcolor); ?>" class="display_table"><a target="_blank"
                href="viewCompany.php?ID=<?php echo $rows["b2bid"]; ?>&proc=View&searchcrit=&show=watertransactions&rec_type=Manufacturer"><?php echo $nickname; //echo "<br>".$rows["company_id"]; 
                                                                                                                                                                                                                                ?></a>
        </td>
        <td class="display_table">
        ...
        <?php $unique_count = $row . "-" . (isset($arcount) - 1); ?>
        <td class="display_table"><?php echo  isset($data_row["vendor_terms"]) ?></td>
        ...
        <td class="display_table" id="made_payment_td-<?php echo $unique_count; ?>"><?php if ($rows["made_payment"] == "1") {
                                                                                            echo 'Yes';
                                                                                        } else {
                                                                                            echo "No";
                                                                                        } ?></td>
        <td class="display_table" id="payment_method_td-<?php echo $unique_count; ?>">
            <?php echo $rows["payment_method"]; ?></td>
        <td class="display_table" id="paid_date_td-<?php echo $unique_count; ?>"><?php echo $rows["paid_date"]; ?></td>
        ...
        <td class="display_table" id="paid_by_td-<?php echo $unique_count; ?>"><?php echo  $rows["paid_by"] ?></td>
        ...
        <td class="display_table">
            <input type='button' id='agtempl<?php echo  $unique_count; ?>' name='send_tmpl' value='Select Template'
                onclick='open_template_vendors_AR(1,<?php echo isset($rows["warehouse_id"]) ?>,<?php echo  $rows["transid"]; ?>,<?php echo  isset($data_row["vendor_id"]); ?>, "<?php echo  $unique_count; ?>")' />
        </td>
        <td class="display_table">
                    ...
                    <div id="editSectionTbl_<?php echo $unique_count ?>"
                        ...
                        <table>
                            <tr>
                                ...
                                <td class="display_table">
                                    <input type="checkbox" name="made_payment" id="made_payment" value="1" <?php if ($rows['made_payment'] == 1) {
                                                                                                                    echo 'checked';
                                                                                                                } ?>>
                                </td>
                                ...
                                <td class="display_table">
                                    <select name="ar_status" id="ar_status">
                                        <?php
                                            ...
                                            ?>
                                        <option value="<?php echo $lowerarvalue ?>" <?php echo $arselectedValue ?>>
                                ...
                                <td class="display_table">
                                    ...
                                    <input type="hidden" name="hdnInvcNo" value="<?php echo $rows["invoice_number"] ?>">
                                    <input type="hidden" name="hdnInvcVendorEmail"
                                        value="<?php echo isset($data_row["contact_email"]) ?>">
                                    <input type="hidden" name="vnumrows" value="<?php echo isset($vnumrows) ?>">
                                    ...
                                    <input type="hidden" name="common_vendor_id"
                                        value="<?php echo  isset($common_vendor_id); ?>">
                                    <input type="hidden" name="edit_report" value="yes" />
                                </td>
                                <td class="display_table">
                                    <input type="button" name="btnUpdateVendrRpt"
                                        id="btnUpdateVendrRpt_<?php echo  $unique_count; ?>" class="btnUpdateVendrRpt"
                                        onclick="update_vendor_report('<?php echo $unique_count; ?>')" value="save">
                                </td>
                                <td class="display_table">
    ...
    <?php
        ...
        $MGarray[] = array(
            ...
            'amt' => $rows["amt"], 'nickname' => $nickname, 'vnumrows' => isset($vnumrows), 'vendor_name' => $rows["Name"] . " - " . $rows["description"] . " - " . $rows['city'] . ", " . $rows['state'] . " " . $rows['zipcode']
        );
    ...
    <!-- <tr>
							...
							<td class="display_table" align="center">
								...
								<input type="hidden" name="vendors_dd" name="vendors_dd" value="<?php echo $_REQUEST["vendors_dd"]; ?>">
								<input type="hidden" name="comp_sel" name="comp_sel" value="<?php echo $_REQUEST["comp_sel"]; ?>">
								<input type="hidden" name="ddMadePayment" name="ddMadePayment" value="<?php echo $_REQUEST["ddMadePayment"]; ?>">
								<input type="hidden" name="vendorpagename"  value="UCBZeroWaste_Vendors_AR.php">
    ...
    if ($_REQUEST["columnno"] == "DONOTUSE3") {
        ...
        foreach ($MGarray as $MGArraytmp) {
            $MGArraysort_B[] = isset($MGArraytmp['amt']);
        }
    ...
    ?>
    <tr>
        <td class="display_table"><?php echo $MGArraytmp["vendor_name"]; ?></td>
        <td class="display_table"><a target="_blank"
                href="viewCompany.php?ID=<?php echo $MGArraytmp["b2bid"]; ?>&proc=View&searchcrit=&show=watertransactions&rec_type=Manufacturer"><?php echo $MGArraytmp["nickname"]; ?></a>
        </td>
        <td class="display_table">
            C: <?php echo  $MGArraytmp["company_contact"] ?> <br>
            P: <?php echo  $MGArraytmp["company_phone"] ?> <br>
            E: <?php echo  $MGArraytmp["company_email"] ?>
        </td>
        <td class="display_table"><?php echo  $MGArraytmp["switchDate"] ?></td>
        <td class="display_table"><?php if ($MGArraytmp["invoice_date"] != "") {
                                                echo date("m/d/Y", strtotime($MGArraytmp["invoice_date"]));
                                            } ?></td>
        <td class="display_table"><?php echo  $MGArraytmp["invoice_number"]; ?></td>
        <td class="display_table">
            <?php if ($MGArraytmp["scan_report"] != "") {
            ...
            <?php }
                            ...
                            ?>
            <a target="_blank" href='water_scanreport/<?php echo $MGArraytmp["scan_report"]; ?>'>
                <font size="1">View Attachments</font>
            </a>
            <?php }
                    } ?>
        ...
        <td class="display_table"><?php echo  $MGArraytmp["company_terms"] ?></td>
        <td class="display_table"><?php echo  date('m/d/Y', strtotime($MGArraytmp["new_invoice_date"])); ?></td>
        <td class="display_table">
            <?php echo  $MGArraytmp["no_invoice_due_marked_on"] != '0000-00-00 00:00:00' ? date('m/d/Y', strtotime($MGArraytmp["no_invoice_due_marked_on"])) : '' ?>
        </td>
        <td class="display_table"><?php echo $MGArraytmp["invoice_age"] ?></td>
        <td class="display_table">$<?php echo number_format($MGArraytmp["amt"], 2); ?></td>
        <td class="display_table"><?php if ($MGArraytmp["made_payment"] == "1") {
                                                echo 'Yes';
                                            } else {
                                                echo "No";
                                            } ?></td>
        <td class="display_table"><?php echo $MGArraytmp["payment_method"]; ?></td>
        <td class="display_table"><?php echo $MGArraytmp["paid_date"]; ?></td>
        <td class="display_table">
            <?php if ($MGArraytmp["payment_proof_file"] != "") {
            ...
            <?php
                            ...
                            ?>
            <a target="_blank" href='water_payment_proof/<?php echo $MGArraytmp["payment_proof_file"]; ?>'>
                <font size="1">View Attachments</font>
            </a>
            <br>
            <?php
        ...
        <td class="display_table"><?php echo  $MGArraytmp["receivable_portal_link"] ?></td>
        <td class="display_table"><?php echo  $MGArraytmp["paid_by"] ?></td>
        <td class="display_table"><?php echo  date('m/d/Y', strtotime($MGArraytmp["paid_date"])) ?></td>
        <td class="display_table"><?php echo  ucfirst($MGArraytmp["ar_status"]) ?></td>
        <td class="display_table"><?php echo  $MGArraytmp["receivable_notes"] ?></td>
        ...
        <td class="display_table">
            ...
            <?php
                    ...
                    ?>
            <form name="frmEditVendrRptLinkpg" method="post" action="editVendrRptLinkpg.php"
                encType="multipart/form-data">
                <table>
                    <tr>
                        <td class="display_table">Made or Received Payment?</td>
                        <td class="display_table">
                            <input type="checkbox" name="made_payment-<?php echo $row; ?>" id="made_payment" value="1">
                        </td>
                        <td class="display_table">Transaction Log Notes:</td>
                        <td class="display_table">
                            <input type="text" name="paid_by-<?php echo $row; ?>" id="paid_by" value=" ">
                        </td>

                        <td class="display_table">Payment Method:</td>
                        <td class="display_table">
                            <input type="text" name="payment_method-<?php echo $row; ?>" id="payment_method" value=" ">
                        </td>

                        <td class="display_table">Status:</td>
                        <td class="display_table">
                            <select name="ar_status-<?php echo $row; ?>" id="ar_status">
                                <?php
                                            foreach ($arStatus as $arKey => $value) {
                                                $lowerarvalue = $arKey != 0 ? strtolower($value) : "";
                        ...
                        <td class="display_table">
                            <select name="company_terms-<?php echo $row; ?>" id="company_terms">
                                ...
                                <?php
                                            ...
                                            ?>
                                <option value="<?php echo $value ?>" <?php echo $termsselectedValue ?>>
                                    <?php echo $value ?></option>
                                <?php } ?>
                            </select>
                        </td>
                        ...
                        <td class="display_table">Transaction Log Date:</td>
                        <td class="display_table"><input type="text" name="paid_date-<?php echo $row; ?>" id="paid_date"
                                value=""></td>

                        <td class="display_table">Select Template</td>
                        <td class="display_table">
                            <select name="dueMailByAR-<?php echo $row; ?>" id="dueMailByAR">
                        ...
                        <td class="display_table">
                            <input type="file" name="payment_proof_file-<?php echo $row; ?>[]" id="payment_proof_file"
                                multiple onchange="GetFileSize()">
                            <input type="hidden" name="hdnWatrTrnstnId-<?php echo $row; ?>"
                                value="<?php echo $MGArraytmp["transid"]; ?>">
                            <input type="hidden" name="hdnvendrId-<?php echo $row; ?>"
                                value="<?php echo $MGArraytmp["vendor_id"]; ?>">
                            <input type="hidden" name="hdnInvcNo-<?php echo $row; ?>"
                                value="<?php echo $MGArraytmp["invoice_number"]; ?>">
                        </td>
                    </tr>
                </table>
                ...
                <a class="btnEdit"
                    id="btnEditSectionOpen_<?php echo $MGArraytmp["invoice_number"]; ?><?php echo $MGArraytmp["transid"]; ?>"
                    onclick="editSectionOpen('<?php echo $MGArraytmp["invoice_number"]; ?><?php echo $MGArraytmp["transid"] ?>')">Edit</a>
                <div id="editSectionTbl_<?php echo $MGArraytmp["invoice_number"]; ?><?php echo $MGArraytmp["transid"]; ?>"
                    style="display: none;">
                    ...
                    <form name="frmEditVendrRptLinkpg" method="post" action="editVendrRptLinkpg.php"
                        ...
                        <table>
                            <tr>
                                <td class="display_table">Made or Received Payment?</td>
                                <td class="display_table">
                                    <input type="checkbox" name="made_payment-<?php echo $row; ?>" id="made_payment"
                                        value="1"
                                        <?php if ($MGArraytmp['made_payment'] == 1) {
                                                                                                                                                echo 'checked';
                                                                                                                                            } ?>>
                                </td>
                                <td class="display_table">Paid/Received by:</td>
                                <td class="display_table">
                                    <input type="text" name="paid_by-<?php echo $row; ?>" id="paid_by"
                                        value="<?php echo $MGArraytmp["paid_by"] ?>">
                                </td>

                                <td class="display_table">Payment Method:</td>
                                <td class="display_table">
                                    <input type="text" name="payment_method-<?php echo $row; ?>" id="payment_method"
                                        value="<?php echo $MGArraytmp["payment_method"] ?>">
                                </td>
                                ...
                                <td class="display_table">Transaction Log Date:</td>
                                <td class="display_table"><input type="text" name="paid_date-<?php echo $row; ?>"
                                        id="paid_date" value="<?php echo $MGArraytmp["paid_date"] ?>"></td>
                                ...
                                <td class="display_table">Remittance Confirmation:</td>
                                <td class="display_table">
                                    <input type="file" name="payment_proof_file-<?php echo $row; ?>[]"
                                        id="payment_proof_file" multiple onchange="GetFileSize()">
                                    <input type="hidden" name="hdnWatrTrnstnId-<?php echo $row; ?>"
                                        value="<?php echo $MGArraytmp["transid"] ?>">
                                    <input type="hidden" name="hdnvendrId-<?php echo $row; ?>"
                                        value="<?php echo $MGArraytmp["vendor_id"] ?>">
                                ...
                                <td class="display_table">
                                    <a id="btnCancelSectionClose_<?php echo $MGArraytmp["invoice_number"]; ?>"
                                        class="btnEdit"
                                        onclick="cancelSectionClose('<?php echo $MGArraytmp["invoice_number"]; ?>')">Cancel</a>
                                </td>
                            </tr>
                        </table>
                </div>
    ...
    $_SESSION["exportARArray"] = isset($MGarray);
