...
$return_url = isset($_SERVER['HTTP_REFERER']) ? $_SERVER['HTTP_REFERER'] : "hannibalwarehouse_141592653.php";
...
<head>
    ...
    <script type="text/javascript">
        ...
        function update_list() {
            ...
            item_total = document.getElementById("ddlist")
            total = total + item_total.value * 1

            if (total == 1) {
                document.getElementById("dock").value = "Dock 6 - Soup Totes"
                document.getElementById("carrier").value = "Sharkeys"
                document.getElementById("destination_id").value = 27
            }
            if (total == 2) {
                document.getElementById("dock").value = "Dock 15 - Main Recycling"
                document.getElementById("carrier").value = "Sharkeys"
                document.getElementById("destination_id").value = 27
            }
            if (total == 3) {
                document.getElementById("dock").value = "Dock 28 - GMI Totes"
                document.getElementById("carrier").value = "Sharkeys"
                document.getElementById("destination_id").value = 27
            }
            if (total == 4) {
                document.getElementById("dock").value = "Dock 66 - Annex Recycling"
                document.getElementById("carrier").value = "Sharkeys"
                document.getElementById("destination_id").value = 27
            }
            if (total == 5) {
                document.getElementById("dock").value = "No Dock Selected"
                document.getElementById("carrier").value = "Sharkeys"
                document.getElementById("destination_id").value = 27
            }
            if (total == 6) {
                document.getElementById("dock").value = "GMI Reuse Totes"
                document.getElementById("carrier").value = "Sharkeys"
                document.getElementById("destination_id").value = 27
            }
        }
...
<body>
    ...
    <div class="main_data_css">
        ...
        <form method="post" name="BOLForm" action="hannibal_gmi_inbound_trailer_save.php">
            <input type=hidden value="Sharkeys" name="carrier" id="carrier">
            <!-- <input type=hidden value="<?php echo $_REQUEST["warehouse_id"]; ?>" name="warehouse_id"> -->
            <input type=hidden value="<?php echo  $return_url; ?>" name="return_url">
            <input type=hidden value="27" id="destination_id" name="destination_id">
            ...
            <table border="0">
                ...
                <tr>
                    ...
                    <td colspan="2" class="style3">
                        <select name="ddlist" id="ddlist" onchange="update_list()" style="width:180px;">
                            <option value="5"></option>
                            <option value="1">Dock 6 - Soup Totes</option>
                            <option value="2">Dock 15 - Main Recycling</option>
                            <option value="3">Dock 28 - GMI Totes</option>
                            <option value="4">Dock 66 - Annex Recycling</option>
                            <option value="6">GMI Reuse Totes</option>
                        </select>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td colspan="2" class="style3">
                        ...
                        ?>
                        <input type="text" name="pickup_date" size="11" value="<?php echo date('m/d/Y', $pickup_date); ?>"> <a href="#" onclick="cal2xx.select(document.BOLForm.pickup_date,'anchor0xx','MM/dd/yyyy'); return false;" name="anchor0xx" id="anchor0xx"><img border="0" src="images/calendar.jpg"></a>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="style3">
                        51 inch Totes<input type="hidden" name="item_1" value="51 inch Totes">
                    </td>
                </tr>
                <tr>
                    <td class="style3">
                    ...
                    <td class="style3">
                        <input name="weight_2" size="10" value="" id="weight_2" onchange="update_cart()" disabled="true">
                    </td>
                    <td class="style3">
                        41 inch Totes<input type="hidden" name="item_2" value="41 inch Totes">
                    </td>
                </tr>
                <tr>
                    <td class="style3">
                    ...
                    <td class="style3">
                        34 inch Totes<input type="hidden" name="item_3" value="34 inch Totes">
                    </td>
                </tr>
                <tr>
                    <td class="style3">
                    ...
                    <td class="style3">
                        4 Way White Wood Pallets<input type="hidden" name="item_4" value="4 Way White Wood Pallets">
                    </td>
                </tr>
                <tr>
                    <td class="style3">
                    ...
                    <td class="style3">
                        <input name="weight_5" size="10" id="weight_5" value="" onchange="update_cart()" disabled="true">
                    </td>
                    <td class="style3">
                        <input type="text" size="55" value="Other: Check box &amp; replace text with item description" name="item_5">
                    </td>
                </tr>
                <tr>
                    <td class="style3">
                        <input name="check_6" id="check_6" onclick="chk_field(6)" type="checkbox" value="1">
                    </td>
                    <td class="style3">
                        <input name="count_6" size="10" id="count_6" value="" onchange="update_cart()" disabled="true">
                    </td>
                    <td class="style3">
                        <input name="weight_6" size="10" id="weight_6" value="" onchange="update_cart()" disabled="true">
                    </td>
                    <td class="style3">
                        <input type="text" size="55" value="Other: Check box &amp; replace text with item description" name="item_6">
                    </td>
                </tr>
                <tr>
                    <td class="style3">
                ...
                <tr>
                    <td colspan="4" class="style3 txtcenter">
                        <input type="submit" name="btntool" value="Generate Bill of Lading and Request Trailer" onclick="FormCheck();" />
                    </td>
                </tr>
