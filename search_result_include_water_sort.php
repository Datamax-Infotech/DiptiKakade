<Font Face='arial' size='2'>
            ...
            xmlhttp.onreadystatechange = function() {
                if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
                    if (xmlhttp.responseText == "Duplicate") {
                        alert(
                            "The UCBZeroWaste Consolidated Invoice has already been created for this month. Please enter the Vendor Report under the following month, or, create an UCBZW Accounting Log instructing the Consolidated Invoice Team to charge this invoice under the next month UCBZeroWaste Consolidated Invoice."
                        );
                    }
                }
            }

            xmlhttp.open("POST", "water_entry_chk_onservice_end_dt.php?comp_id=" + document.getElementById(
                    "warehouse_id").value + "&vendor_id=" + document.getElementById("vendor_id").value +
                "&invoice_date=" + document.getElementById("invoice_date").value, true);
            xmlhttp.send();
        }
    }
    ...
    function showfees_other(row_cnt) {
        ...
        if (document.getElementById("selfees" + row_cnt).value != "") {
            ...
            xmlhttp.open("POST", "water_entry_getsaving_cat_id.php?add_fee_id=" + document.getElementById("selfees" +
                row_cnt).value, true);
            xmlhttp.send();
        }
    }
    ...
    function chkduplicateinv() {
        if (document.getElementById("invoice_no").value != "") {
            ...
            xmlhttp.onreadystatechange = function() {
                if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
                    if (xmlhttp.responseText == "Duplicate") {
                        alert("A Vendor Report with the same Invoice Number - " + document.getElementById(
                                "invoice_no").value +
                            " has already been added, you will not be able to save two Vendor Reports with the same Invoice Number."
                        );
            ...
            xmlhttp.open("POST", "water_entry_chkinv.php?comp_id=" + document.getElementById("warehouse_id").value +
                "&invno=" + document.getElementById("invoice_no").value, true);
            xmlhttp.send();
        }
    }
    ...
    function removeattachment(invfile, recid, compid, wid) {
        ...
        xmlhttp.open("POST", "water_entry_removefile.php?recid=" + recid + "&invfile=" + invfile + "&compid=" + compid +
            "&wid=" + wid, true);
        xmlhttp.send();
    }
    ...
    function removeattachment_proof(invfile, recid, compid, wid) {
        ...
        xmlhttp.open("POST", "water_entry_removefile.php?payment_proof=1&recid=" + recid + "&invfile=" + invfile +
            "&compid=" + compid + "&wid=" + wid, true);
        xmlhttp.send();
    }
            ...
            if (str_array[5] == "By Weight") {
                ...
                if ($tot_count == 0) {
                    ...
                    if (document.getElementById("water_item1").value != "0") {
                        if (document.getElementById("txtcostperunit1").value == "" && document.getElementById(
                                "txtrevenueperunit1").value == "") {
                        ...
                        if (document.getElementById("txtweight1").value == "") {
                            msgstr = msgstr +
                                "'Weight' (EVEN IF the material item is priced 'Per Item' OR 'Per Number of Pulls', an estimated weight amount has to be inserted)";
                        }
                    }
                }
                ...
                if ($tot_count == 0) {
                    ...
                    if (document.getElementById("water_item1").value != "0") {
                        ...
                        if (document.getElementById("txtunitcount1").value == "") {
                            msgstr = msgstr +
                                "'Unit Count' (ONLY if the material item is priced 'Per Item' or 'Per Number of Pulls')\r\n";
                        }
                        if (document.getElementById("txtweight1").value == "") {
                            msgstr = msgstr +
                                "'Weight' (EVEN IF the material item is priced 'Per Item' OR 'Per Number of Pulls', an estimated weight amount has to be inserted)";
    ...
    function loadaddfees() {
        ...
        xmlhttp.onreadystatechange = function() {
            if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
                document.getElementById("div_fees").innerHTML = document.getElementById("div_fees").innerHTML +
    ...
    function water_item_showdetails(ctrlcnt) {
        ...
        if (str_array[1] == "Cost Per Unit") {
            ...
            document.getElementById("txttotalcost" + ctrlcnt).value = (str_array[3] * Number(document.getElementById(
                "txtweight" + ctrlcnt).value)).toFixed(2);
        ...
        if (str_array[1] == "Revenue Per Unit") {
            ...
            document.getElementById("txttotalrevenue" + ctrlcnt).value = (str_array[3] * Number(document.getElementById(
                "txtweight" + ctrlcnt).value)).toFixed(2);
        ...
        if (str_array[5] == "By Number of Pulls") {
            ...
            if (str_array[6] == "Cost Per Pull") {
                ...
                document.getElementById("txttotalcost" + ctrlcnt).value = (str_array[3] * Number(document
                    .getElementById("txtweight" + ctrlcnt).value)).toFixed(2);
            ...
            if (str_array[6] == "Revenue Per Pull") {
                ...
                document.getElementById("txttotalrevenue" + ctrlcnt).value = (str_array[3] * Number(document
                    .getElementById("txtweight" + ctrlcnt).value)).toFixed(2);
        ...
        if (str_array[5] == "Per Item") {
            ...
            if (str_array[7] == "Cost Per Item") {
                ...
                document.getElementById("txttotalcost" + ctrlcnt).value = (str_array[3] * Number(document
                    .getElementById("txtunitcount" + ctrlcnt).value)).toFixed(2);
    ...
    function water_item_convunit(ctrlcnt) {
        ...
        if (str_array[5] == "By Weight") {
            if (untinm != str_array[2]) {
                ...
                if (untinm == "Gallon" && str_array[2] == "Gallon") { //alert('Gallon&Gallon'); 
                    ...
                    document.getElementById("txttotweight" + ctrlcnt).innerHTML = ((document.getElementById(
                        "txtweight" + ctrlcnt).value * poundpergallon) * unitcount).toFixed(2);
                }
            }
        }
        ...
        if (str_array[5] == "Per Item" || str_array[5] == "By Number of Pulls") {
            ...
            if (document.getElementById("weight_unit" + ctrlcnt).value == "Pounds") {
                ...
                document.getElementById("txttotweight" + ctrlcnt).innerHTML = (document.getElementById("txtweight" +
                    ctrlcnt).value * unitcount).toFixed(2);
            }
            if (document.getElementById("weight_unit" + ctrlcnt).value == "Tons") {
                ...
                document.getElementById("txttotweight" + ctrlcnt).innerHTML = ((document.getElementById("txtweight" +
                    ctrlcnt).value * 2000) * unitcount).toFixed(2);
            }
            if (document.getElementById("weight_unit" + ctrlcnt).value == "Kilograms") {
                ...
                document.getElementById("txttotweight" + ctrlcnt).innerHTML = ((document.getElementById("txtweight" +
                    ctrlcnt).value * 2.20462) * unitcount).toFixed(2);
            }
            ...
            if (document.getElementById("weight_unit" + ctrlcnt).value == "Gallon") {
                //document.getElementById("txttotweight"+ctrlcnt).innerHTML = ((document.getElementById("txtweight"+ctrlcnt).value * 11) * unitcount).toFixed(2);
                document.getElementById("txttotweight" + ctrlcnt).innerHTML = ((document.getElementById("txtweight" +
                    ctrlcnt).value * poundpergallon) * unitcount).toFixed(2);
            }
    ...
    function loaddata(warehouse_id, editflg) {
        ...
        xmlhttp.open("POST", "water_getboxrep.php?warehouse_id=" + warehouse_id + "&vendorid=" + vendor_id +
            "&editflg=" + editflg, true);
        xmlhttp.send();
    }
    ...
    function calculateunitcount(ctrcnt) {
        ...
        if (str_array[5] == "Per Item" || str_array[5] == "By Number of Pulls") {
            ...
            if (document.getElementById("weight_unit" + ctrcnt).value == "Pounds") {
                document.getElementById("txttotweight" + ctrcnt).innerHTML = (document.getElementById("txtweight" +
                    ctrcnt).value * unitcount).toFixed(2);
            }
            if (document.getElementById("weight_unit" + ctrcnt).value == "Tons") {
                document.getElementById("txttotweight" + ctrcnt).innerHTML = ((document.getElementById("txtweight" +
                    ctrcnt).value * 2000) * unitcount).toFixed(2);
            }
            if (document.getElementById("weight_unit" + ctrcnt).value == "Kilograms") {
                document.getElementById("txttotweight" + ctrcnt).innerHTML = ((document.getElementById("txtweight" +
                    ctrcnt).value * 2.20462) * unitcount).toFixed(2);
            }
            ...
            if (document.getElementById("weight_unit" + ctrcnt).value == "Gallon") {
                ...
                document.getElementById("txttotweight" + ctrcnt).innerHTML = ((document.getElementById("txtweight" +
                    ctrcnt).value * poundpergallon) * unitcount).toFixed(2);
            }
            ...
            if (document.getElementById("weight_unit" + ctrcnt).value == "Gallon") {
                ...
                document.getElementById("txttotweight" + ctrcnt).innerHTML = ((document.getElementById("txtweight" +
                    ctrcnt).value * poundpergallon)).toFixed(2);
            }
        }
    }
    ...
    function update_total() {
        ...
        if (vendor_id == '844') {
            ...
            if (tot_fees) {
                ...
                if (total_profit) {
                    document.getElementById("final_total").value = (txtTotalDueToUcb + total_profit - tot_fees).toFixed(
                        2);
                } else {
    ...
    <form name="frmsort" method="post" action="#" encType="multipart/form-data" onsubmit="return onsubmitform();">
        ...
        <input type="hidden" name="warehouse_id" id="warehouse_id" value="<?php echo isset($id); ?>" />
        ...
        <table cellSpacing="1" cellPadding="1" border="0" style="width: 600px" id="table4">
            ...
            <tr align="middle">
                <td bgColor="#c0cdda" colSpan="6">
                    <font size="1">Select Vendor:
                        <select id="vendor_id" name="vendor_id" onchange="loaddata(<?php
                                                                                        echo isset($id); ?>,0)">
                            <option value=""></option>
                            <?php
                                $vendor_ids = "";
                                db();
                                $query = db_query("SELECT water_inventory.vendor FROM water_boxes_to_warehouse INNER JOIN water_inventory ON water_boxes_to_warehouse.water_boxes_id = water_inventory.id WHERE water_boxes_to_warehouse.water_warehouse_id = " . isset($id) . " group by water_inventory.vendor");
                                ...
                                db();
                                $query = db_query("SELECT * FROM water_vendors where active_flg = 1 and id in ($vendor_ids) order by Name");
                                while ($rowsel_getdata = array_shift($query)) {
                                ...
                                ?>
                            <option value="<?php echo $rowsel_getdata[" id"]; ?>" <?php
                                                                                            echo isset($tmp_str); ?>>
                                <?php echo $vender_nm; ?>
                            </option>
                            <?php }
            ...
            <tr bgColor="#e4e4e4">
                ...
                <td height="13" colspan="3" class="style1" align="left">
                    <input type="text" name="report_date" id="report_date" size="20" readonly
            ...
            <tr bgColor="#e4e4e4">
                ...
                <td height="13" colspan="3" class="style1" align="left">
                    <input type="text" name="service_begin_date" id="service_begin_date" size="20" readonly
                        value="<?php echo isset($_GET['service_begin_date']) ? $_GET['service_begin_date'] : ''; ?>">
                    <a href="#"
                        onclick="cal4xx.select(document.frmsort.service_begin_date,'dtanchor4xx','yyyy-MM-dd'); return false;"
            ...
            <tr bgColor="#e4e4e4">
                ...
                <td height="13" colspan="3" class="style1" align="left">
                    <input type="text" name="invoice_date" id="invoice_date" size="20" readonly
                        value="<?php echo isset($_GET['invoice_date']) ? $_GET['invoice_date'] : ''; ?>">
                    <a href="#"
                        onclick="cal2xxdup.select(document.frmsort.invoice_date,'dtanchor3xx','yyyy-MM-dd'); return false;"
            ...
            <tr bgColor="#e4e4e4">
                ...
                <td height="13" colspan="3" class="style1" align="left">
                    <input type="text" name="new_invoice_date" id="new_invoice_date" size="20" readonly
                        value="<?php echo isset($_GET['new_invoice_date']) ? $_GET['new_invoice_date'] : ''; ?>">
                    <a href="#"
                        onclick="cal5xx.select(document.frmsort.new_invoice_date,'dtanchor5xx','yyyy-MM-dd'); return false;"
                        name="dtanchor5xx" id="dtanchor5xx"><img border="0" src="images/calendar.jpg"></a>
                </td>
            </tr>
            ...
            <tr bgColor="#e4e4e4">
                ...
                <td height="13" colspan="3" class="style1" align="left">
                    <input type="text" name="invoice_due_date" id="invoice_due_date" size="20" readonly
                        value="<?php echo isset($_GET['invoice_due_date']) ? $_GET['invoice_due_date'] : ''; ?>">
                    <a href="#"
                        onclick="cal6xx.select(document.frmsort.invoice_due_date,'dtanchor6xx','yyyy-MM-dd'); return false;"
                        name="dtanchor6xx" id="dtanchor6xx"><img border="0" src="images/calendar.jpg"></a>
                </td>
            </tr>
            ...
            <tr bgColor="#e4e4e4">
                ...
                <td height="13" colspan="3" class="style1" align="left">
                    <input type="text" name="invoice_no" id="invoice_no" size="20" value=""
                        onchange="chkduplicateinv()">
                </td>
            </tr>
            <tr bgColor="#e4e4e4" id="ucbzw_extra_display2" style="display: none;">
                ...
                <td height="13" colspan="3" class="style1" align="left">
                    <input type="text" name="txtNetcostRev" id="txtNetcostRev" size="20" value=""
                        onchange="calcTotalDuetoucb()">
                </td>
            </tr>
            ...
            <tr bgColor="#e4e4e4" id="ucbzw_extra_display5" style="display: none;">
                ...
                <td height="13" colspan="3" class="style1" align="left">
                    <input type="text" name="txtUCBSavingsSplit" id="txtUCBSavingsSplit" size="20" value=""
                        onchange="calcTotalDuetoucb()">
                </td>
            </tr>
            ...
            <tr bgColor="#e4e4e4">
                ...
                <td height="13" colspan="3" class="style1" align="left">
                    <input type="button" name="btn_no_inv" id="btn_no_inv" value="NO INVOICE"
                        onclick="mark_btn_no_inv()">
                </td>
            </tr>

            <tr align="middle">
                <td bgColor="#c0cdda" class="style1" colspan="6">MATERIALS</td>
            </tr>
            ...
            <tr bgColor="#e4e4e4">
                <td colspan="7">
                    <input type="checkbox" name="chkdoubt" id="chkdoubt" value="1" />
                    <font size="1">I have a Question</font>
            ...
            <tr bgColor="#e4e4e4">
                <td colspan="7">
                    <table id="tblmain_fees">
                        <thead>
                            <tr>
                                <th bgColor="#c0cdda" class="first">
                                    <font size="1">ADDITIONAL FEES & CREDITS</font>
                                </th>
                                <th bgColor="#c0cdda">
                                    <font size="1">COST ($) PER UNIT</font>
                                </th>
                                <th bgColor="#c0cdda">
                                    <font size="1">OCCURRENCES</font>
                                </th>
                                <th bgColor="#c0cdda">
                                    <font size="1">TOTAL COST ($)</font>
                                </th>
                                <th bgColor="#c0cdda">
                                    <font size="1">SAVINGS CALCULATION CATEGORY</font>
                                </th>
                                <th bgColor="#c0cdda">
                                    <font size="1">REMARK</font>
                                </th>
                            </tr>
                        </thead>
                        ...
                        <tbody>
                            <?php
                                ...
                                $blank_row_str .= "</td>";
                                $blank_row_str .= "<td> <input type='text' name='txtcharge[]' onkeypress='return chknumberval(event, " . $row_cnt . ");' id='txtcharge" . $row_cnt . "' value='" . isset($item_charge) . "' onchange='update_fee_total()' size='5' /></td>";
                                ...
                                $blank_row_str .= "<td>";
                                $sql = "SELECT savings_calculation_category_id, savings_calculation_category, 1 as savings_calculation_category_flg from water_savings_calculation_category	union SELECT commodity_id as savings_calculation_category_id, commodity as savings_calculation_category , 2 as savings_calculation_category_flg
				                from base_line_commodity_master where 
                                ...
                                $blank_row_str .= "<td> <input type='text' name='txtremark_fees[]' id='txtremark_fees' value='" . isset($item_remark) . "' size='20' /> </td>";
                    ...
                    <table>
                        <tr>
                            <td colspan="8" align="right">
                                <input type="button" name="add_newrec" id="add_newrec" value="Add New Row"
                                    onclick="add_newrow_fees()">
                                <input type="hidden" name="row_cnt_fees" id="row_cnt_fees"
                                    value="<?php echo $row_cnt; ?>">
                                <input type="hidden" name="row_str_fees" id="row_str_fees"
                                    value="<?php echo $blank_row_str; ?>">
                            </td>
                        </tr>
                    </table>
                </td>
            ...
            <tr bgColor="#e4e4e4">
                ...
                <td height="13" colspan="3" class="style1" align="left">
                    <?php echo $_COOKIE["userinitials"]; ?>
                    <input type="hidden" name="hidtxtnumrows" value="<?php echo $num_rows; ?>">
                    <input size="10" type="hidden" name="txtEditedBY" id="txtEditedBY"
            ...
            <tr bgColor="#e4e4e4">
                ...
                <td height="13" class="style1" align="left" colspan="5">
                    <Font size='2' Face="arial">
                        <input type="checkbox" name="make_receive_payment" id="make_receive_payment" value="1"
                            onchange="show_vendor_payment_report()">
                    </font>
                </td>
            </tr>
            <tr>
                <td height="13" class="style1" align="left" colspan="6">
                    <div id="vendor_pay_reportid" style="display: none;">
                        <table width="100%" class="vendor_payment_css" cellpadding="0" cellspacing="1">
                            <tr bgColor="#e4e4e4">
                                <th colspan="2" class="first" align="center" bgcolor="#c0cdda" style="height: 22px;">
                                    <font size="2">Vendor Payment Report</font>
                                </th>
                            </tr>
                            <tr bgColor="#e4e4e4">
                            ...
                            <tr bgColor="#e4e4e4">
                                ...
                                <td>
                                    <input type="file" name="payment_proof_file[]" id="payment_proof_file" multiple
            ...
            <Font Face='arial' size='2'>
                <tr bgColor="#e4e4e4">
                    <td colspan=6 align="left" height="19" class="style1">
                        <p align="center">
                            <input type="hidden" name="count" value="<?php echo isset($count); ?>">
                            <input type="hidden" name="tot_fees" id="tot_fees" value="">
                            <input type="submit" value="SAVE" id="water_entry_btn" name="water_entry_btn"
                                style="cursor:pointer;">&nbsp;<input type="button" value="RESET" onclick="resetctrls()"
        ...
        <table cellSpacing="1" cellPadding="1" border="0" style="width: 600px" id="table4">
            <tr align="middle">
                <td bgColor="#c0cdda" colSpan="8">
                    <font size="1">VENDOR REPORT [In Edit Mode]</font>
                </td>
            </tr>
            <?php
                ...
                ?>
            <?php if ($dt_view_tran_row["vendor_id"] == 844) { ?>
            ...
            <tr align="middle">
                <td bgColor="#c0cdda" colSpan="8">
                    <font size="1">Select Vendor:
                        <select id="vendor_id" name="vendor_id" onchange="loaddata(<?php echo isset($id); ?>,1)">
                            <option value=""></option>
                            <?php
            ...
            <tr bgColor="#e4e4e4">
                ...
                <td height="13" colspan="5" class="style1" align="left">
                    <input type="text" name="report_date" id="report_date" size="20" readonly
                        value="<?php echo isset($dt_view_tran_row['report_date']) ? $dt_view_tran_row['report_date'] : ''; ?>">
                </td>
            </tr>
            <tr bgColor="#e4e4e4">
                <td colspan="3" height="13" class="style1" align="right">
                ...
                <td height="13" colspan="5" class="style1" align="left">
                    <select name="invoice_currency" id="invoice_currency">
                        <option <?php if ($dt_view_tran_row['invoice_currency'] == "U.S. Dollars") {
                                        echo "selected='selected'";
                                    } ?>>U.S. Dollars</option>
                        <option <?php if ($dt_view_tran_row['invoice_currency'] == "Canadian Dollars") {
                                        echo "selected='selected'";
            ...
            <tr bgColor="#e4e4e4">
                ...
                <td height="13" colspan="3" class="style1" align="left">
                    <input type="text" name="service_begin_date" id="service_begin_date" size="20"
                        value="<?php echo isset($dt_view_tran_row['service_begin_date']) ? $dt_view_tran_row['service_begin_date'] : ''; ?>">
                    <a href="#"
                        onclick="cal4xx.select(document.frmsortedit.service_begin_date,'dtanchor4xx','yyyy-MM-dd'); return false;"
                        name="dtanchor4xx" id="dtanchor4xx"><img border="0" src="images/calendar.jpg"></a>
                </td>
            </tr>
            ...
            <tr bgColor="#e4e4e4">
                ...
                <td height="13" colspan="5" class="style1" align="left">
                    <input type="text" name="invoice_date" id="invoice_date" readonly size="20"
                        value="<?php echo isset($dt_view_tran_row['invoice_date']) ? $dt_view_tran_row['invoice_date'] : ''; ?>">
                    <a href="#"
                        onclick="cal2xx.select(document.frmsortedit.invoice_date,'dtanchor3xx','yyyy-MM-dd'); return false;"
                        name="dtanchor3xx" id="dtanchor3xx"><img border="0" src="images/calendar.jpg"></a>
                    <div ID="listdiv"
                        STYLE="position:absolute;visibility:hidden;background-color:white;layer-background-color:white;">
                    </div>
            ...
            <tr bgColor="#e4e4e4">
                ...
                <td height="13" colspan="3" class="style1" align="left">
                    <input type="text" name="new_invoice_date" id="new_invoice_date" size="20"
                        value="<?php echo isset($dt_view_tran_row['new_invoice_date']) ? $dt_view_tran_row['new_invoice_date'] : ''; ?>">
                    <a href="#"
                        onclick="cal5xx.select(document.frmsortedit.new_invoice_date,'dtanchor5xx','yyyy-MM-dd'); return false;"
                        name="dtanchor5xx" id="dtanchor5xx"><img border="0" src="images/calendar.jpg"></a>
                </td>
            </tr>
            ...
            <tr bgColor="#e4e4e4">
                ...
                <td height="13" colspan="3" class="style1" align="left">
                    <input type="text" name="invoice_due_date" id="invoice_due_date" size="20"
                        value="<?php echo isset($dt_view_tran_row['invoice_due_date']) ? $dt_view_tran_row['invoice_due_date'] : ''; ?>">
                    <a href="#"
                        onclick="cal6xx.select(document.frmsortedit.invoice_due_date,'dtanchor6xx','yyyy-MM-dd'); return false;"
                        name="dtanchor6xx" id="dtanchor6xx"><img border="0" src="images/calendar.jpg"></a>
                </td>
            </tr>
            ...
            <tr bgColor="#e4e4e4">
                ...
                <td height="13" colspan="5" class="style1" align="left">
                    <input type="text" name="invoice_no" id="invoice_no" size="20" value="<?php echo $dt_view_tran_row["
                        invoice_number"]; ?>" onchange="chkduplicateinv()">
                </td>
            </tr>
            <?php if ($dt_view_tran_row["vendor_id"] == 844) { ?>
            <tr bgColor="#e4e4e4" id="ucbzw_extra_display2">
                ...
                <td height="13" colspan="3" class="style1" align="left">
                    <input type="text" name="txtNetcostRev" id="txtNetcostRev" size="20"
                        value="<?php echo  $dt_view_tran_row["vendors_net_cost_or_revenue"]; ?>"
                        onchange="calcTotalDuetoucb()">
                </td>
            </tr>
            <tr bgColor="#e4e4e4" id="ucbzw_extra_display3">
                ...
                <td height="13" colspan="3" class="style1" align="left">
                    <input type="text" name="txtGrossSavings" id="txtGrossSavings" size="20"
                        value="<?php echo  $dt_view_tran_row["gross_savings"]; ?>">
                </td>
            </tr>
            <tr bgColor="#e4e4e4" id="ucbzw_extra_display4">
                ...
                <td height="13" colspan="3" class="style1" align="left">
                    <input type="text" name="txtClientNetSavings" id="txtClientNetSavings" size="20"
                        value="<?php echo  $dt_view_tran_row["client_net_savings"]; ?>">
                </td>
            </tr>
            <tr bgColor="#e4e4e4" id="ucbzw_extra_display5">
                ...
                <td height="13" colspan="3" class="style1" align="left">
                    <input type="text" name="txtUCBSavingsSplit" id="txtUCBSavingsSplit" size="20"
                        value="<?php echo  $dt_view_tran_row["ucb_savings_split"]; ?>" onchange="calcTotalDuetoucb()">
                </td>
            </tr>
            <tr bgColor="#e4e4e4" id="ucbzw_extra_display6">
                ...
                <td height="13" colspan="3" class="style1" align="left">
                    <input type="text" name="txtTotalDueToUcb" id="txtTotalDueToUcb" size="20"
                        value="<?php echo  $dt_view_tran_row["total_due_to_ucb"]; ?>" readonly>
                </td>
            </tr>
            <?php } ?>
            <tr bgColor="#e4e4e4">
                ...
                <td height="13" colspan="3" class="style1" align="left">
                    ...
                    <?php
                        ...
                        ?>
                    <input type="button" name="btn_no_inv_rev" id="btn_no_inv_rev" value="UNDO - NO INVOICE"
                        onclick="mark_btn_no_inv_edit_undo()">
                    <?php
                        } else {
                        ?>
                    <input type="button" name="btn_no_inv" id="btn_no_inv" value="NO INVOICE"
                        onclick="mark_btn_no_inv_edit()">
                    <?php
                        }
                        ?>
            ...
            <tr bgColor="#e4e4e4">
                ...
                <td height="13" colspan="5" class="style1" align="left" id="scanfiletd">
                    <?php if ($dt_view_tran_row["scan_report"] != "") {
                    ...
                    <input type="button" name="btnremoveattachment" id="btnremoveattachment" value="X"
                        onclick="removeattachment('<?php echo $elements[$i]; ?>', <?php echo $rec_id; ?>, <?php echo $_REQUEST['ID']; ?>, <?php echo isset($id); ?>)" />
                    <br>
                    <?php }
                            } else {
                                ?>
                    <a target="_blank" href='water_scanreport/<?php echo $dt_view_tran_row["scan_report"]; ?>'>
                        <font size="1">View Attachments</font>
                    </a>
                    <input type="button" name="btnremoveattachment" id="btnremoveattachment" value="X" onclick="removeattachment('<?php echo $dt_view_tran_row[" scan_report"]; ?>',
                    <?php echo $rec_id; ?>,
                ...
                <td colspan="8">
                    <div id="div_boxrep">
                        <table id="tblmain_entry" width="600px" cellSpacing="1" cellPadding="1" border="0">
                            <tr>
                                <th bgColor="#c0cdda" colspan="12">
                                    <font size="1">MATERIALS</font>
                                </th>
                            </tr>
                            <tr>
                                <th bgColor="#c0cdda" class="first">
                                    <font size="1">WATER ITEM</font>
                                </th>
                                <th bgColor="#c0cdda">
                                    <font size="1">COST ($) PER UNIT</font>
                                </th>
                                <th bgColor="#c0cdda">
                                    <font size="1">REVENUE ($) PER UNIT</font>
                                </th>
                                <th bgColor="#c0cdda">
                                    <font size="1">UNIT COUNT</font>
                                </th>
                                <th bgColor="#c0cdda" width="120">
                                ...
                                <th bgColor="#c0cdda">
                                    <font size="1">OUTLET</font>
                                </th>
                                <th bgColor="#c0cdda">
                                    <font size="1">BASELINE COMMODITY</font>
                                </th>
                                <th bgColor="#c0cdda">
                                    <font size="1">BASELINE RATE (COST)/UNIT</font>
                                </th>
                                <th bgColor="#c0cdda">
                                    <font size="1">BASELINE RATE (REVENUE)/UNIT</font>
                                </th>
                            ...
                            <?php
                                ...
                                $display_header = "n";
                                $display_header2 = "n";
                                $CostOrRevenuePerUnit = "";
                                db();
                                $get_boxes_query = db_query("SELECT *, water_inventory.id as boxid FROM water_boxes_report_data INNER JOIN water_inventory ON water_boxes_report_data.box_id = water_inventory.id WHERE water_boxes_report_data.trans_rec_id = " . $rec_id . " order by water_boxes_report_data.id asc");
                                $i = 0;
                                $ctrlcnt = 0;
                                $tot_val1 = 0;
                                $tot_cost = 0;
                                ...
                                while ($boxes = array_shift($get_boxes_query)) {
                                    ...
                                    $base_line_rate_cost = "";
                                    $base_line_rate_revenue = "";
                                    $base_line_commodity = "";
                                    $q1 = "select cm.*, um.unit_of_measure as uom, um.id as uom_id from base_line_commodity_master cm join base_line_unit_of_measure um on cm.unit_of_measure=um.id where cm.active_flg = 1 and cm.commodity_id = '" . $boxes["base_line_commodity_id"] . "'";
                                    db();
                                    $query = db_query($q1);
                            ...
                            <tr bgColor="#e4e4e4">
                                <td height="13" class="style1" align="center">
                                    <?php echo $boxes["description"] . "/" . $boxes["WeightorNumberofPulls"]; ?>
                                </td>



                                <?php if ($boxes["CostOrRevenuePerUnit"] == "Cost Per Unit" || $boxes["CostOrRevenuePerPull"] == "Cost Per Pull" || $boxes["CostOrRevenuePerItem"] == "Cost Per Item") { ?>
                                <td height="13" class="style1" align="right">
                                    <input size="3" name="txtcostperunit[]" type="text"
                                        onkeypress='return IsNumeric(event);' id="txtcostperunit<?php echo $ctrlcnt; ?>"
                                        onchange="calculatecost(<?php echo $ctrlcnt; ?>)" value="<?php echo $boxes["
                                        value_each"]; ?>">
                                    <span id="txtcostunit<?php echo $ctrlcnt; ?>">
                                        <?php if ($boxes["WeightorNumberofPulls"] == "By Number of Pulls") { ?>
                                        <?php
                                                        echo "/Pull";
                                                    } else {
                                                        if ($boxes["AmountUnit"] != "") {
                                                            echo "/" . $boxes["AmountUnit"];
                                                        }
                                                    }
                                                    ?>
                                    </span>
                                ...
                                <td height="13" class="style1" align="right">
                                    <input size="3" name="txtcostperunit[]" type="text"
                                        onkeypress='return IsNumeric(event);' id="txtcostperunit<?php echo $ctrlcnt; ?>"
                                        style="display:none;" onchange="calculatecost(<?php echo $ctrlcnt; ?>)"
                                        value="<?php echo $boxes[" value_each"]; ?>">
                                </td><span id="txtcostunit<?php echo $ctrlcnt; ?>"></span>
                                <?php }  ?>
                                <?php if ($boxes["CostOrRevenuePerUnit"] == "Revenue Per Unit" || $boxes["CostOrRevenuePerPull"] == "Revenue Per Pull" || $boxes["CostOrRevenuePerItem"] == "Revenue Per Item") { ?>
                                <td height="13" class="style1" align="right">
                                    <input size="3" name="txtrevenueperunit[]" type="text"
                                        onkeypress='return IsNumeric(event);'
                                        id="txtrevenueperunit<?php echo $ctrlcnt; ?>"
                                        onchange="calculaterevenue(<?php echo $ctrlcnt; ?>)" value="<?php echo $boxes["
                                        value_each"]; ?>">
                                    <span id="txtrevenueunit<?php echo $ctrlcnt; ?>">
                                        <?php if ($boxes["AmountUnit"] != "") {
                                                        echo "/" . $boxes["AmountUnit"];
                                                    } ?>
                                    </span>
                                </td>
                                ...
                                <td height="13" class="style1" align="right">
                                    <input size="3" name="txtrevenueperunit[]" type="text"
                                        onkeypress='return IsNumeric(event);'
                                        id="txtrevenueperunit<?php echo $ctrlcnt; ?>" style="display:none;"
                                        onchange="calculaterevenue(<?php echo $ctrlcnt; ?>)"
                                        value="<?php echo $boxes[" value_each"]; ?>">
                                </td><span id="txtrevenueunit<?php echo $ctrlcnt; ?>"></span>
                                <?php }  ?>
                                <td height="13" class="style1" align="right">
                                    <input size="3" name="txtunitcount[]" type="text"
                                        id="txtunitcount<?php echo $ctrlcnt; ?>" onkeypress='return IsNumeric(event);'
                                        onchange="calculateunitcount(<?php echo $ctrlcnt; ?>)" value="<?php echo $boxes["
                                        unit_count"]; ?>">
                                </td>

                                <td height="13" class="style1" align="right">
                                    <Font Face='arial' size='2'>
                                        <input size="3" name="txtweight[]" type="text"
                                            id="txtweight<?php echo $ctrlcnt; ?>" onkeypress='return IsNumeric(event);'
                                            onchange="calculateweightnew(<?php echo $ctrlcnt; ?>)" value="<?php echo $boxes["
                                            weight"]; ?>">
                                        <select name='weight_unit[]' id='weight_unit<?php echo $ctrlcnt; ?>'
                                            onchange='water_item_convunit(<?php echo $ctrlcnt; ?>)' style='width: 60px'>
                                            <?php
                                                    $selectedval_1 = "";
                                                    $selectedval_2 = "";
                                                    $selectedval_3 = "";
                                            ...
                                            <option value="Tons" <?php echo $selectedval_1; ?>>Tons (T)</option>
                                            <option value="Pounds" <?php echo $selectedval_2; ?>>Pounds (lb)</option>
                                            <option value="Kilograms" <?php echo $selectedval_3; ?>>Kilograms (kg)
                                            </option>
                                            <option value="Gallon" <?php echo $selectedval_4; ?>>Gallon (gal)</option>
                                        </select>
                                        <span id="txttotweight<?php echo $ctrlcnt; ?>" style='font-size:10;'></span>
                                </td>
                                <?php if ($boxes["CostOrRevenuePerUnit"] == "Cost Per Unit" || $boxes["CostOrRevenuePerPull"] == "Cost Per Pull" || $boxes["CostOrRevenuePerItem"] == "Cost Per Item") {
                                ...
                                <td height="13" class="style1" align="right">
                                    <Font Face='arial' size='2'>
                                        <input size="5" name="txttotalcost[]" type="text" readonly
                                            id="txttotalcost<?php echo $ctrlcnt; ?>"
                                            value="<?php echo $boxes[" total_value"];
                                                                                                                                                                ?>">
                                </td>
                                <?php } else { ?>
                                <td height="13" class="style1" align="right">
                                    <Font Face='arial' size='2'>
                                        <input size="5" name="txttotalcost[]" type="text" readonly style="display:none;"
                                            id="txttotalcost<?php echo $ctrlcnt; ?>"
                                            value="<?php echo $boxes[" total_value"];
                                                                                                                                                                                        ?>">
                                </td>
                                ...
                                <td height="13" class="style1" align="right">
                                    <Font Face='arial' size='2'>
                                        <input size="5" name="txttotalrevenue[]" type="text" readonly
                                            id="txttotalrevenue<?php echo $ctrlcnt; ?>" value="<?php echo $boxes["
                                            total_value"]; ?>">
                                </td>
                                <?php } else { ?>
                                <td height="13" class="style1" align="right">
                                    <Font Face='arial' size='2'>
                                        <input size="5" name="txttotalrevenue[]" type="text" readonly
                                            style="display:none;" id="txttotalrevenue<?php echo $ctrlcnt; ?>"
                                            value="<?php echo $boxes[" total_value"]; ?>">
                                </td>
                                <?php }  ?>
                                <td align="left" height="13" style="width: 80px" class="style1">
                                    <input type="hidden" name="water_item[]" id="water_item<?php echo $ctrlcnt; ?>"
                                        value="<?php echo $boxes[" boxid"] . "|" . $boxes["CostOrRevenuePerUnit"] . "|" .
                                                                                                                                        $boxes["AmountUnit"] . "|" . $boxes["Amount"] . "|" . $boxes["Outlet"] . "|" .
                                                                                                                                        $boxes["WeightorNumberofPulls"] . "|" . $boxes["CostOrRevenuePerPull"] . "|" .
                                                                                                                                        $boxes["CostOrRevenuePerItem"] . "|" . $boxes["Estimatedweight"] . "|" .
                                                                                                                                        $boxes["Estimatedweight_value"] . "|" .
                                                                                                                                        $boxes["Estimatedweight_peritem"] . "|"
                                                                                                                                        . $boxes["Estimatedweight_value_peritem"] . "|" .
                                                                                                                                        $boxes["poundpergallon_value"] . "|" .
                                                                                                                                        $base_line_commodity . "|" . $base_line_rate_cost . "|" .
                                                                                                                                        $base_line_rate_revenue; ?>" />
                                    <input type="hidden" name="box_id[]" value="<?php echo $boxes[" boxid"]; ?>" />
                                    <input type="hidden" name="poundpergallon[]"
                                        id="pound_per_gallon<?php echo $ctrlcnt; ?>" value="<?php echo $boxes["
                                        poundpergallon_value"]; ?>" />
                                    <input type="hidden" name="CostOrRevenuePerUnit[]"
                                        value="<?php echo $CostOrRevenuePerUnit; ?>" />
                                    <input type="hidden" name="box_weight" id="box_weight<?php echo $ctrlcnt; ?>"
                                        value="<?php echo $boxes[" bweight"]; ?>" />
                                    <input type="hidden" name="box_value" id="box_value<?php echo $ctrlcnt; ?>"
                                        value="<?php echo $boxes[" boxgoodvalue"]; ?>" />
                                    <input type="hidden" name="outlet[]" id="outlet<?php echo $ctrlcnt; ?>"
                                        value="<?php echo $boxes[" Outlet"]; ?>" />
                                    <font size="1" Face="arial">
                                        <?php echo $boxes["Outlet"]; ?>
                                    </font>
                                </td>
                                <td align="left" height="13" style="width: 80px" class="style1">
                                    <font size="1" Face="arial">
                                        <?php echo $base_line_commodity; ?>
                                    </font>
                                </td>
                                <td align="left" height="13" style="width: 80px" class="style1">
                                    <font size="1" Face="arial">
                                        <?php echo $base_line_rate_cost; ?>
                                    </font>
                                </td>
                                <td align="left" height="13" style="width: 80px" class="style1">
                                    <font size="1" Face="arial">
                                        <?php echo $base_line_rate_revenue; ?>
                                    </font>
                                </td>

                                <td bgColor='#e4e4e4'> <input type='button' name='btnremove[]' id='btnremove' value='X'
                                        onclick='remove_newrow_main(this)' /> </td>
                            ...
                            <?php
                                    ...
                                    db();
                                    $result = db_query($get_boxes_query1);
                        ...
                        <table id="tblmain_entry" width="600px" cellSpacing="1" cellPadding="1" border="0">
                            <tr>
                                <td colspan="12" align="right" bgColor='#e4e4e4'>
                                    <input type="button" name="add_newrec" id="add_newrec" value="Add New Row"
                                        onclick="add_newrow_main()">
                                    <input type="hidden" name="row_cnt_main" id="row_cnt_main"
                                        value="<?php echo $ctrlcnt; ?>">
                                    <input type="hidden" name="row_str_main" id="row_str_main"
                                        value="<?php echo isset($blank_row_str); ?>">
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td align="right" bgColor='#e4e4e4'>
                                    <input type="text" name="txttotal_revenue" id="txttotal_revenue" size="5" readonly
                                        value="<?php echo $tot_revenue; ?>">
                                </td>
                            ...
                            <tr>
                                ...
                                <td align="right" bgColor='#e4e4e4'>
                                    <input type="text" name="txttotal_cost" id="txttotal_cost" size="5" readonly
                                        value="<?php echo $tot_cost; ?>">
                                </td>
                                <td align="right" bgColor='#e4e4e4'>&nbsp;</td>
                            </tr>
                            <tr>
                                ...
                                <td align="right" bgColor='#e4e4e4'>
                                    <input type="text" name="txttotal_profit" id="txttotal_profit" size="5" readonly
                                        value="<?php echo $tot_revenue - $tot_cost; ?>">
                                </td>
                                <td align="right" bgColor='#e4e4e4'>&nbsp;</td>
                            </tr>
                        </table>
            ...
            <?php
                ...
                ?>
            <script LANGUAGE="JavaScript">
            loaddata(<?php echo isset($id); ?>, 0);
            </script>
            <?php } ?>
            <tr bgColor="#e4e4e4">
                <td colspan="12">
                    <input type="checkbox" name="chkdoubt" id="chkdoubt" value="1" <?php echo $chkdoubt_val; ?> />
                    <font size="1">I have a Question
                        &nbsp;<input type="text" name="txtdoubt" id="txtdoubt" value="<?php echo $doubt; ?>" /></font>
            </tr>
                        ...
                        <tbody>
                            <?php
                                ...
                                while ($myrowsel_main = array_shift($result_main)) {
                                    ...
                                    $blank_row_str .= "<td>";
                                    $sql = "SELECT savings_calculation_category_id, savings_calculation_category, 1 as savings_calculation_category_flg from water_savings_calculation_category	union
            ...
            <tr bgColor="#e4e4e4">
                ...
                <td height="13" colspan="5" class="style1" align="left">
                    <input size="10" type="text" name="final_total" readonly id="final_total"
                        value="<?php echo ($dt_view_tran_row[" total_due_to_ucb"] + ($tot_revenue - $tot_cost) -
                                                                                                                $tot_add_fees); ?>">
                </td>
            </tr>
            ...
            <tr bgColor="#e4e4e4">
                ...
                <td height="13" colspan="5" class="style1" align="left">
                    <?php echo $dt_view_tran_row["repor_entry_emp"]; ?>
                    <input type="hidden" name="hidtxtnumrows" value="<?php echo $num_rows; ?>">
                    <input size="10" type="hidden" name="txtEditedBY" id="txtEditedBY"
                        value="<?php echo $_COOKIE['userinitials']; ?>">
                </td>
            ...
            <tr bgColor="#e4e4e4">
                ...
                <td height="13" class="style1" align="right" colspan="5">
                    <Font size='2' Face="arial">
                        <p align="left">
                            <textarea rows="3" cols="30" name="boxnotes"
                                id="boxnotes"><?php echo $dt_view_tran_row["report_notes"]; ?></textarea>
                        </p>
                    </Font>
                </td>
            </tr>
            <tr bgColor="#e4e4e4">
                ...
                <td height="13" class="style1" align="left" colspan="5">
                    <Font size='2' Face="arial">
                        <input type="checkbox" name="make_receive_payment" id="make_receive_payment" value="1"
                            <?php if ($dt_view_tran_row["make_receive_payment"] == "1") {
                                                                                                                        echo 'checked';
                                                                                                                    } ?> onchange="show_vendor_payment_report()">
                    </font>
                </td>
                ...
                <td height="13" class="style1" align="left" colspan="6">
                    <div id="vendor_pay_reportid">
                        <table width="100%" class="vendor_payment_css" cellpadding="0" cellspacing="1">
                            ...
                            <tr bgColor="#e4e4e4">
                                <td class="style1" align="right" width="285px">Made Payment or Received Payment?</td>
                                <td><input type="checkbox" name="made_payment" id="made_payment" value="1"
                                        <?php if ($dt_view_tran_row["made_payment"] == "1") {
                                                                                                                        echo 'checked';
                                                                                                                    } ?>></td>
                            </tr>
                            <?php
                            ...
                            <tr bgColor="#e4e4e4">
                                <td class="style1" align="right">Vendor Credit:</td>
                                <td><input type="text" name="vendor_credit" id="vendor_credit"
                                        value="<?php echo $dt_view_tran_row[" vendor_credit"]; ?>"></td>
                            </tr>
                            <?php } ?>
                            <tr bgColor="#e4e4e4">
                                <td class="style1" align="right">Paid/Received by:</td>
                                <td><input type="text" name="paid_by" id="paid_by" value="<?php echo $dt_view_tran_row["
                                        paid_by"]; ?>"></td>
                            </tr>
                            <tr bgColor="#e4e4e4">
                                <td class="style1" align="right">Paid/Received date:</td>
                                <td><input type="text" name="paid_date" id="paid_date"
                                        value="<?php echo $dt_view_tran_row[" paid_date"]; ?>"></td>
                            </tr>
                            <tr bgColor="#e4e4e4">
                                <td class="style1" align="right">Payment Method:</td>
                                <td><input type="text" name="payment_method" id="payment_method"
                                        value="<?php echo $dt_view_tran_row[" payment_method"]; ?>"></td>
                            </tr>
                            <tr bgColor="#e4e4e4">
                                <td class="style1" align="right">Payment proof file:</td>
                                <td id="proof_filetd">
                                    <?php if ($dt_view_tran_row["payment_proof_file"] != "") {
                                    ...
                                    <input type="button" name="btnremoveattachment_proof" id="btnremoveattachment_proof"
                                        value="X"
                                        onclick="removeattachment_proof('<?php echo $elements[$i]; ?>', <?php echo $rec_id; ?>, <?php echo $_REQUEST['ID']; ?>, <?php echo isset($id); ?>)" />
                                    <br>
                                    <?php }
                                                } else {
                                                    ?>
                                    <a target="_blank"
                                        href='water_payment_proof/<?php echo $dt_view_tran_row["payment_proof_file"]; ?>'>
                                        <font size="1">View Attachments</font>
                                    </a>
                                    <input type="button" name="btnremoveattachment_proof" id="btnremoveattachment_proof"
                                        value="X" onclick="removeattachment_proof('<?php echo $dt_view_tran_row["
                                        payment_proof_file"]; ?>',
                                    <?php echo $rec_id; ?>,
                                    <?php echo $_REQUEST['ID']; ?>,
                                    <?php echo isset($id); ?>)" />
            ...
            <tr bgColor="#e4e4e4">
                <td colspan=8 align="left" height="19" class="style1">
                    <p align="center">
                        <input type="hidden" name="count" value="<?php echo isset($count); ?>">
                        <input type="hidden" name="tot_fees" id="tot_fees" value="">
                        <input style="cursor:pointer;" type="submit" id="water_entry_btn" name="water_entry_btn"
                            value="SAVE">
    ...
    <table cellSpacing="1" cellPadding="1" border="0" id="table4">
        <tr align="middle">
            <td bgColor="#c0cdda" colSpan="12">
                <font size="1">VENDOR REPORT</font>
                <a
                    href="viewCompany_func_water-mysqli.php?ID=<?php echo  $_REQUEST['ID'] ?>&show=watertransactions&warehouse_id=<?php echo isset($id); ?>&b2bid=<?php echo isset($b2bid); ?>&rec_id=<?php echo $rec_id; ?>&rec_type=<?php echo isset($rec_type); ?>&proc=View&searchcrit=&display=water_sort&sort_edit=true">EDIT</a>
            </td>
        </tr>
        ...
        <tr bgColor="#e4e4e4">
            ...
            <td height="14" class="style1" align="left" colspan="10">
                <p align="left">
                    <font size="1">
                        <?php echo $dt_view_tran_row["invoice_currency"]; ?>
                    </font>
            </td>
        </tr>
        <tr bgColor="#e4e4e4">
            ...
            <td height="14" class="style1" align="left" colspan="10">
                <p align="left">
                    <font size="1">
                        <?php echo $dt_view_tran_row["service_begin_date"]; ?>
                    </font>
            </td>
        </tr>
        ...
        <tr bgColor="#e4e4e4">
            ...
            <td height="14" class="style1" align="left" colspan="10">
                <p align="left">
                    <font size="1">
                        <?php echo $dt_view_tran_row["invoice_date"]; ?>
                    </font>
            </td>
        </tr>
        <tr bgColor="#e4e4e4">
            ...
            <td height="14" class="style1" align="left" colspan="10">
                <p align="left">
                    <font size="1">
                        <?php echo $dt_view_tran_row["new_invoice_date"]; ?>
                    </font>
            </td>
        </tr>
        <tr bgColor="#e4e4e4">
            ...
            <td height="14" class="style1" align="left" colspan="10">
                <p align="left">
                    <font size="1">
                        <?php echo $dt_view_tran_row["invoice_due_date"]; ?>
                    </font>
            </td>
        </tr>
        ...
        <tr bgColor="#e4e4e4">
            ...
            <td height="14" class="style1" align="left" colspan="10">
                <p align="left">
                    <font size="1">
                        <?php echo $dt_view_tran_row["report_date"]; ?>
                    </font>
            </td>
        </tr>
        ...
        <tr bgColor="#e4e4e4">
            ...
            <td height="14" colspan="10" class="style1" align="left">
                <font size="1">
                    <?php echo $dt_view_tran_row["invoice_number"]; ?>
                </font>
            </td>
        </tr>
        <?php if ($dt_view_tran_row["vendor_id"] == 844) { ?>
        <tr bgColor="#e4e4e4">
            ...
            <td height="14" colspan="10" class="style1" align="left">
                <font size="1">
                    <?php echo "$" . $dt_view_tran_row["vendors_net_cost_or_revenue"]; ?>
                </font>
            </td>
        </tr>
        <tr bgColor="#e4e4e4">
            ...
            <td height="14" colspan="10" class="style1" align="left">
                <font size="1">
                    <?php echo "$" . $dt_view_tran_row["gross_savings"]; ?>
                </font>
            </td>
        </tr>
        <tr bgColor="#e4e4e4">
            ...
            <td height="14" colspan="10" class="style1" align="left">
                <font size="1">
                    <?php echo "$" . $dt_view_tran_row["client_net_savings"]; ?>
                </font>
            </td>
        </tr>
        <tr bgColor="#e4e4e4">
            ...
            <td height="14" colspan="10" class="style1" align="left">
                <font size="1">
                    <?php echo "$" . $dt_view_tran_row["ucb_savings_split"]; ?>
                </font>
            </td>
        </tr>
        <tr bgColor="#e4e4e4">
            ...
            <td height="14" colspan="10" class="style1" align="left">
                <font size="1">
                    <?php echo "$" . $dt_view_tran_row["total_due_to_ucb"]; ?>
                </font>
            </td>
        </tr>
        <?php } ?>
        ...
        <tr>
            <td class="style1" style="width: 150px; height: 13px" bgColor="#c0cdda">
                <font size="1">Water Item</font>
            </td>
            <td class="style1" style="width: 80px;" bgColor="#c0cdda">
                <font size="1">Cost ($) Per Unit</font>
            </td>
            <td class="style1" style="width: 80px;" bgColor="#c0cdda">
                <font size="1">Revenue ($)<br>Per unit</font>
            </td>
            <td class="style1" style="width: 80px;" bgColor="#c0cdda">
                <font size="1">Unit Count</font>
            </td>
            <td class="style1" style="width: 20px;" bgColor="#c0cdda" width="150">
                <font size="1">Weight</font>
            </td>
            <td class="style1" style="width: 20px;" bgColor="#c0cdda" width="150">
                <font size="1">Total Weight</font>
            </td>
            <td class="style1" style="width: 20px;" bgColor="#c0cdda">
                <font size="1">Total Cost ($)</font>
            </td>
            <td class="style1" style="width: 20px;" bgColor="#c0cdda">
                <font size="1">Total Revenue ($)</font>
            </td>
            <td class="style1" style="width: 10px;" bgColor="#c0cdda">
                <font size="1">Outlet</font>
            </td>
            <td class="style1" style="width: 10px;" bgColor="#c0cdda">
                <font size="1">Baseline commodity</font>
        ...
        <?php
                ...
                while ($dt_view_row = array_shift($dt_view_res)) {
                    ...
                    $base_line_rate_revenue = "";
                    $base_line_commodity = "";
                    $q1 = "select cm.*, um.unit_of_measure as uom, um.id as uom_id from base_line_commodity_master cm join base_line_unit_of_measure um on cm.unit_of_measure=um.id where cm.active_flg = 1 and cm.commodity_id = '" . $dt_view_row["base_line_commodity_id"] . "'";
                    db();
                    $query = db_query($q1);
                    while ($data_row = array_shift($query)) {
                        $base_line_commodity = $data_row['commodity'];
	...
	if ($WeightorNumberofPulls == "Number of Pulls"){
        ...
        <tr bgColor="#e4e4e4">
            ...
            <?php if ($dt_view_row["CostOrRevenuePerUnit"] == "Cost Per Unit" || $dt_view_row["CostOrRevenuePerPull"] == "Cost Per Pull" || $dt_view_row["CostOrRevenuePerItem"] == "Cost Per Item") { ?>
            <td height="13" class="style1" align="right">
                <?php echo "$" . $dt_view_row["value_each"]; ?>
                <?php if ($WeightorNumberofPulls == "By Number of Pulls") { ?>
                <?php
                                    echo "/Pull";
                                } else {
                                    if ($dt_view_row["AmountUnit"] != "") {
                                        echo "/" . $dt_view_row["AmountUnit"];
                                    }
                                }
                                ?>
            </td>
            ...
            <?php }  ?>
            <?php if ($dt_view_row["CostOrRevenuePerUnit"] == "Revenue Per Unit"  || $dt_view_row["CostOrRevenuePerPull"] == "Revenue Per Pull" || $dt_view_row["CostOrRevenuePerItem"] == "Revenue Per Item") { ?>
            <td height="13" class="style1" align="right">
                <?php echo "$" . $dt_view_row["value_each"]; ?>
                <?php if ($dt_view_row["AmountUnit"] != "") {
                                    echo "/" . $dt_view_row["AmountUnit"];
                                } ?>
            </td>
            <?php } else { ?>
            ...
            <td height="13" class="style1" align="right">
                <?php echo $dt_view_row["unit_count"]; ?>
            </td>
			...
			/***************************/
                            ...
                            ?>
                <?php echo number_format($dt_view_row["weight"], 2) . " " . $weightUnit; ?>
            </td>
            ...
            <td height="13" class="style1" align="right">
                <Font Face='arial' size='1'>
                    <?php echo $dt_view_row["total_value"]; ?>
            </td>
            <?php } else { ?>
            <td height="13" class="style1" align="right">&nbsp;
        ...
        <tr bgColor="#e4e4e4">
            <td colspan="12">
                <input type="checkbox" name="chkdoubt" id="chkdoubt" value="1" <?php echo $chkdoubt_val; ?> disabled />
                <font size="1">I have a Question
                    &nbsp;
                    <?php echo $doubt; ?>
                </font>
        ...
        <Font size='1'>
            ...
            <?php
			        ...
			        on water_additional_fees.id = water_trans_addfees.add_fees_id where trans_id = " . $rec_id);
                    while ($rowsel_getdata = array_shift($query)) {
            ...
            <tr bgColor="#e4e4e4">
                ...
                <td height="13" class="style1" align="right">
                    <?php if ($rowsel_getdata["add_fees"] > 0) {
                                        echo '$' . $rowsel_getdata["add_fees"];
                                    } ?>
                </td>
                <td height="13" class="style1" align="center">
                    <?php echo $rowsel_getdata["add_fees_occurance"]; ?>
                </td>
                <td height="13" class="style1" align="center">
                    <?php echo ($rowsel_getdata["add_fees"] * $rowsel_getdata["add_fees_occurance"]); ?>
                </td>

                <td height="13" class="style1" align="center">
                    <font size="1">
                        <?php echo $savings_calculation_category; ?>
                    </font>
                </td>

                <td height="13" class="style1" align="center">
                    <font size="1">
                        <?php echo $rowsel_getdata["add_fee_remark"]; ?>
                    </font>
                </td>
            </tr>
            <?php
            ...
            <tr bgColor="#e4e4e4">
                ...
                <td height="13" class="style1" align="left" colspan="5">
                    <p align="left">
                        <font size="1">
                            <?php echo $dt_view_tran_row["report_notes"]; ?>
                        </font>
                    </p>
                </td>
            </tr>
...
<?php if ($dt_view_tran_row["reportEntryEditedEmp"] != "") { ?>
<tr bgColor="#e4e4e4">
    <td colspan="5" height="13" class="style1" align="left">
        Edited By: </td>
    <td height="13" class="style1" align="left" colspan="5">
        <p align="left">
            <font size="1">
                <?php echo $dt_view_tran_row["reportEntryEditedEmp"]; ?>
            </font>
    </td>
</tr>
<?php } ?>
...
<tr bgColor="#e4e4e4">
    ...
    <td height="13" class="style1" align="left" colspan="5">
        <p align="left">
            <font size="1">
                <?php echo $dt_view_tran_row["transaction_date"]; ?>
            </font>
    </td>
</tr>
<tr bgColor="#e4e4e4">
    ...
    <td height="13" class="style1" align="left" colspan="11">
        <table width="100%" class="vendor_payment_css" cellpadding="0" cellspacing="1">
            ...
            <tr bgColor="#e4e4e4">
                ...
                <td>
                    <font size="1">
                        <?php echo $dt_view_tran_row["vendor_credit"]; ?>
                    </font>
                </td>
            </tr>
            <?php } ?>
            <tr bgColor="#e4e4e4">
                ...
                <td>
                    <font size="1">
                        <?php echo $dt_view_tran_row["paid_by"]; ?>
                    </font>
                </td>
            </tr>
            <tr bgColor="#e4e4e4">
                ...
                <td>
                    <font size="1">
                        <?php echo $dt_view_tran_row["paid_date"]; ?>
                    </font>
                </td>
            </tr>
            <tr bgColor="#e4e4e4">
                ...
                <td>
                    <font size="1">
                        <?php echo $dt_view_tran_row["payment_method"]; ?>
                    </font>
                </td>
            </tr>
...
<tr bgColor="#e4e4e4">
    ...
    <td colspan="10" height="13" class="style1" align="left">
        ...
        <a
            href="viewCompany_func_water-mysqli.php?ID=<?php echo  $_REQUEST['ID'] ?>&show=watertransactions&warehouse_id=<?php echo isset($id); ?>&b2bid=<?php
                                                                                                                                                                echo isset($b2bid); ?>&rec_id=<?php echo $rec_id; ?>&rec_type=<?php echo isset($rec_type); ?>&proc=View&searchcrit=&entry_confirmed=yes&display=water_sort&sort_edit=false"><input
                type="button" name="confirmed_btn" value="Confirm"></a>
    </td>
    <?php
            }
    ?>
...
<?php }
    ...
    if (isset($_REQUEST["entry_confirmed"]) && $_REQUEST["entry_confirmed"] == "yes") {
        ...
        echo "window.location.href=\"viewCompany_func_water-mysqli.php?ID=" . $_REQUEST['ID'] . "&show=watertransactions&warehouse_id=" . isset($id) . "&b2bid=" . isset($b2bid) . "&rec_id=" . $rec_id . "&rec_type=" . isset($rec_type) . "&proc=View&searchcrit=&display=water_sort&sort_edit=false\";";
        echo "</script>";
        echo "<noscript>";
        echo "<meta http-equiv=\"refresh\" content=\"0;url=viewCompany_func_water-mysqli.php?ID=" . $_REQUEST['ID'] . "&show=watertransactions&warehouse_id=" . isset($id) . "&b2bid=" .
            isset($b2bid) . "&rec_id=" . $rec_id . "&rec_type=" . isset($rec_type) . "&proc=View&searchcrit=&display=water_sort&sort_edit=false\" />";
        echo "</noscript>";
        exit;
    }
?>
