                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="card shadow p-5 d-flex justify-content-center align-items-center border-top-primary">
                                    ...
                                    <h3><b><?php echo $conclusion_data['todo'];?></b></h3>    
                                </div>
                            </div>
                            <div class="col-md-6 mt-4">
                                <div class="card shadow p-5 d-flex justify-content-center align-items-center border-top-primary">
                                    ...
                                    <p>AVERAGE RATING</p> 
                                    <h3><b><?php echo $conclusion_data['rating']; ?></b></h3>  
                                </div>
                            </div>
                            <div class="col-md-6 mt-4">
                                <div class="card shadow p-5 d-flex justify-content-center align-items-center border-top-primary">
                                    <img src="assets_new_dashboard/img/minutes.svg" class="img-fluid"/> 
                                    <p><?php echo $conclusion_data['time']; ?></p>  
                                    <h3><b><?php echo $conclusion_data['minutes']; ?></b></h3>
                                </div>
                            </div>
                        </div>
                    </div>
