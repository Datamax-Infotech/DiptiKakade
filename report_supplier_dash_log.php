...
db();
?>
<title>B2B Supplier Online Portal Login Accounts Summary Report</title>
...
function loadmainpg() {
    ...
    if (document.getElementById('date_from').value != "" && document.getElementById('date_to').value != "") {
        document.rpt_leaderboard.action = "report_supplier_dash_log.php";
    } else {
...
<div class="main_data_css">
    <div class="dashboard_heading" style="float: left;">
        <div style="float: left;">
            B2B Supplier Online Portal Login Accounts Summary Report
        </div>

        &nbsp;<div class="tooltip"><i class="fa fa-info-circle" aria-hidden="true"></i>
            <span class="tooltiptext">This report allows the user to see all logins created for the B2B Online Supplier
                Portals.</span>
        </div><br>
    ...
    <form method="get" name="rpt_leaderboard" action="report_supplier_dash_log.php">
        <table>
            <tr>
    ...
    <table width="80%" border="0" cellspacing="1" cellpadding="1">
        ...
        <?php 		
			...
			$dt_view_qry = "SELECT supplier_dash_user_log.*, um.user_name, um.companyid FROM supplier_dash_user_log left JOIN supplier_dash_usermaster AS um ON um.loginid = supplier_dash_user_log.userid";
			$dt_view_qry .= " WHERE (login_datetime between '" . $date_from . " 00:00:00' AND '" .$date_to." 23:59:59') ORDER BY supplier_dash_user_log.unqid DESC ";
			//echo $dt_view_qry;
        ...
        <tr>
            <td bgColor="#e4e4e4" class="style12">
                <a href="https://tools.keycdn.com/geo?host=<?php echo $dt_view_row["ipaddress"];?>"
                    target="_blank"><?php echo $dt_view_row["ipaddress"];?></a>
            </td>
            ...
            <td bgColor="#e4e4e4" class="style12"><a
            ...
            <td bgColor="#e4e4e4" class="style12">
                <?php echo date("m/d/Y H:i:s", strtotime($dt_view_row["login_datetime"])) . " CT";?></td>
