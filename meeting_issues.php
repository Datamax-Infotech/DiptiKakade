                    ...
                    <div class="container-fluid  mt-0">
                        <div class="row justify-content-center mt-4">
                            ...
                            <div class="col-md-10">
                                <?php
                                db_project_mgmt();
                                $issue_order_str_qry = db_query("SELECT issue_order,show_issue_number from meeting_live_updates where meeting_timer_id='" . $meeting_timer_id . "' && attendee_id=" . $_COOKIE['b2b_id']);
                                ...
                                $issue_sql = db_query("SELECT issue_master.id,issue,order_no,issue_master.status,created_by FROM issue_master	where meeting_id=$meeting_id && issue_master.status=1 $order_str, id DESC");
                                $no_data_div = "d-none";
                                ...
                                db_query("UPDATE meeting_live_updates set issue_flg=0 where meeting_timer_id='" . $meeting_timer_id . "' && attendee_id=" . $_COOKIE['b2b_id']);
                                ?>
                                            ...
                                            <div class="card-header bg-white">
                                                <div class="d-flex justify-content-between align-items-center">
                                                    ...
                                                    <div class="d-flex align-items-center justify-content-between small-font w-50">
                                                        <input type="checkbox" id="show_issue_number" <?php echo  $show_issue_number == 1 ? "checked " : ""; ?> class="checkbox_lg" />&nbsp;<b>Show numbers</b>
                                                        <select class="form-control form-control-sm ml-3" id="sort_issue">
                                                            <option value="0" <?php echo $sort_issue == 0 ? "selected " : ""; ?>>Sort</option>
                                                            <option value="1" <?php echo $sort_issue == 1 ? "selected " : ""; ?>>By Priority(1,2 & 3)</option>
                                                            <option value="2" <?php echo $sort_issue == 2 ? "selected " : ""; ?>>By Owner</option>
                                                            <option value="3" <?php echo $sort_issue == 3 ? "selected " : ""; ?>>By Date Created (Oldest First)</option>
                                                            <option value="4" <?php echo $sort_issue == 4 ? "selected " : ""; ?>>By Date Created (Newest First)</option>
                                                            <option value="5" <?php echo $sort_issue == 5 ? "selected " : ""; ?>>Alphabetically</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        ?>
                                                            <tr id="meeting_issue_tr_<?php echo $r['id']; ?>">
                                                                <td class="show_sr_no td_w_5" style="display:<?php echo  $show_issue_number == 1 ? 'revert' : 'none'; ?>"><?php echo $sr_no; ?></td>
        ...
        <script>
            ...
            function update_order_no_of_current_solved_issue(issue_id) {
                $.ajax({
                    ...
                    data: {
                        issue_id,
                        update_issue_status_of_resoled_issue: 1
                    },
                    datatype: 'json',
                    async: false,
            ...
            $(document).ready(function() {
                ...
                $('#meeting_issue_save').submit(function() {
                    ...
                    all_data.append('meeting_id', "<?php echo $meeting_id; ?>");
                    all_data.append('meeting_timer_id', "<?php echo $meeting_timer_id; ?>");
                    $.ajax({
                        url: 'issue_action.php',
                        type: 'post',
                        data: all_data,
                ...
                $(document).on('click', '.solve_meeting_issue', function() {
                    ...
                    $.ajax({
                        ...
                        data: {
                            issue_id,
                            issue_status_update: 'solved',
                            meeting_id: "<?php echo $meeting_id; ?>",
                            meeting_timer_id: "<?php echo $meeting_timer_id; ?>",
                        },
                        datatype: 'json',
                        async: false,
                        success: function(response) {
                ...
                $(document).on('click', '.rank', function() {
                    ...
                    $.each(already_ranking_done, function(k, v) {
                        rank_array.push({
                            'issue_id': $(v).attr('issue_id'),
                            'rank_val': $(v).attr('data-rank')
                        });
                    });
                    ...
                    if (data_rank_attr !== undefined && data_rank_attr !== false) {
                        ...
                        rank_array = new_rank_array.sort((a, b) => {
                            return a.rank_val - b.rank_val;
                        });
                    } else {
                        rank_counter++;
