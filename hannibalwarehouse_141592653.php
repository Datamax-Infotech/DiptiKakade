...
<head>
    ...
    function confirmationRequest(a, b, c) {
        ...
        if (answer) {
            window.location = "<?php echo hannibalwarehousepage() ?>?action=request&req_id=" + b + "&trailer_no=" + a +
                "&dock=" + c;
        } else {
    ...
    function confirmationDelivery(a, b, c) {
        ...
        if (answer) {
            window.location = "<?php echo hannibalwarehousepage() ?>?action=confirm&conf_id=" + b + "&trailer_no=" + a +
                "&dock=" + c;
        } else {
            alert("Request Cancelled");
        }
    ...
    function undoucbdockdoor(trailerno, recid) {
        ...
        if (answer) {
            window.location = "<?php echo hannibalwarehousepage() ?>?action=undoucbdockdoor&conf_id=" + recid +
    ...
    function confirmationRecycling(a, b, c) {
        ...
        if (answer) {
            window.location = "<?php echo hannibalwarehousepage() ?>?action=recycling&conf_id=" + b + "&trailer_no=" +
                a + "&dock=" + c;
        } else {
            alert("Cancelled");
        }
    ...
    function confirmationUcblot(a, b, c) {
        ...
        if (answer) {
            window.location = "<?php echo hannibalwarehousepage() ?>?action=ucblot&conf_id=" + b + "&trailer_no=" + a +
                "&dock=" + c;
        } else {
            alert("Cancelled");
        }
    ...
    function confirmationUnloaded_new(trailer, recid, dock, warehouse_id) {
        ...
        if (hdnsortreportprintstatus != 'Y') {
            alert(
                "Cannot mark as unloaded until a sort report has been printed and status updated. All trailers require a printed sort report before unloading!"
            );
        } else {
    ...
    function undodelivery(trailerno, recid, dockno) {
        ...
        if (answer) {
            window.location = "<?php echo hannibalwarehousepage() ?>?action=undodelivery&conf_id=" + recid +
    ...
    function displayucbinv(colid, sortflg) {
        ...
        xmlhttp.open("GET", "inventory_displayucbinv_warehouse.php?colid=" + colid + "&wid=556" + "&sortflg=" + sortflg,
            true);
        xmlhttp.send();
    }
...
function undorecycling(trailerno, recid, dockno) {
    ...
    if (answer) {
        window.location = "<?php echo hannibalwarehousepage() ?>?action=undorecycling&conf_id=" + recid +
            "&trailer_no=" + trailerno + "&dock=" + dockno;
    } else {
        alert("Request Cancelled");
    }
...
function undoucblot(trailerno, recid, dockno) {
    ...
    if (answer) {
        window.location = "<?php echo hannibalwarehousepage() ?>?action=undoucblot&conf_id=" + recid + "&trailer_no=" +
            trailerno + "&dock=" + dockno;
    } else {
        alert("Request Cancelled");
    }
...
<body onload="JavaScript:timedRefresh(1200000);">
    ...
    <table>
        <tr>
            <td valign="top">
                ...
                <form method="post" action="<?php echo hannibalwarehousepage() ?>" onsubmit="return chkssn();">
                    ...
                    <input type="hidden" name="onlyshow_timeclock"
                        value="<?php echo $_REQUEST["onlyshow_timeclock"] ?>">
                ...
                ?>
                <form method="post" action="<?php echo hannibalwarehousepage() ?>"
                    onsubmit="return chkssn_logout(<?php echo $row["A"] ?>);">
        ...
        <tr vAlign="center">
            ...
            <td bgColor="#e4e4e4" class="style3" align="center" width="50px;">
                <a href="http://whatismyipaddress.com/ip/<?php echo $row["IP"]; ?>"
                    target="_blank"><?php echo $row["IP"]; ?>
            </td>
            <td bgColor="#e4e4e4" align=middle class="style3" width="250px;">
                SSN (last 4 digit) <input type="password" name="ssn_txt_logout"
                    id="ssn_txt_logout<?php echo $row["A"] ?>" value="" size="5" />
    ...
    <td valign="top">
        ...
        <table cellSpacing="1" cellPadding="1" border="0" width="500px;">
            <?php
                ...
                ?>
            <?php
                    $arrLeaderboardHannibal[] = array('name' => $name, 'totalhours' => $hours, "hourrate" => $hourrate, 'efficiency' => isset($efficiency), 'production' => isset($tot_production));
                }
                ?>
            <tr align="middle">
            ...
            <?php
                // array_multisort(
                //     array_column($arrLeaderboardHannibal, 'production'),
                //     SORT_DESC,
                //     array_column($arrLeaderboardHannibal, 'efficiency'),
                //     SORT_DESC,
                //     array_column($arrLeaderboardHannibal, 'totalhours'),
                //     SORT_DESC,
                //     array_column($arrLeaderboardHannibal, 'name'),
                //     SORT_ASC,
                //     $arrLeaderboardHannibal
                // );
                $production = array_column($arrLeaderboardHannibal, 'production');
                $efficiency = array_column($arrLeaderboardHannibal, 'efficiency');
                $totalhours = array_column($arrLeaderboardHannibal, 'totalhours');
                $name = array_column($arrLeaderboardHannibal, 'name');
            ...
            <tr vAlign="center">
                ...
                <td bgColor="#e4e4e4" class="style3" align="left">
                    <?php echo $color .  $arrLeaderboardHannibalV["name"]; ?></font>
                </td>
                <td bgColor="#e4e4e4" class="style3" align="center">
                ...
                <td bgColor="#e4e4e4" class="style3" align="center">
                    <?php echo $color . "$" . number_format((float)$arrLeaderboardHannibalV["production"], 2);
                            ?>
                    </font>
                </td>
                <td bgColor="#e4e4e4" class="style3" align="center">
                    <?php
                            ...
                            $production = floatval($arrLeaderboardHannibalV["production"]);
                            $hourrate = floatval($arrLeaderboardHannibalV["hourrate"]);
                            $totalhours = floatval($arrLeaderboardHannibalV["totalhours"]);

                            $formatted_production = number_format($production, 2, '.', '');
                            $formatted_hourrate = number_format($hourrate, 2, '.', '');
                            $formatted_totalhours = number_format($totalhours, 2, '.', '');

                            // Removing commas is not necessary since we used '.' as the decimal separator
                            $money_lost = $formatted_production - ($formatted_hourrate * $formatted_totalhours);
                            ...
                            if ($money_lost > 0) {
                                ...
                                $money_lost_tot = isset($money_lost_tot) + $money_lost;
                            }
                            ?>
                    </font>
                </td>
        ...
        <table cellSpacing="1" cellPadding="1" border="0" width="300">
            ...
            <tr vAlign="center">
                ...
                <td bgColor="#e4e4e4" class="style12" style="width: 10%">
                    <a href="https://b2c.usedcardboardboxes.com/pending_shipments.php?tbl=hannibal&fromdash=y&posting=yes"
                        target="_blank"><?php echo $count_pc3; ?></a>
                </td>
                <td bgColor="#e4e4e4" class="style12" style="width: 10%">
                    <a href="https://b2c.usedcardboardboxes.com/shipments_shipped.php?tbl=hannibal&fromdash=y&posting=yes"
                        target="_blank"><b><?php echo $count_pc_tot_for_day2; ?></b></a>
                </td>
            </tr>
        </table>
        <?php  } ?>
    ...
    <td valign="top">
        ...
        <table cellSpacing="1" cellPadding="1" border="0" width="300px;">
            ...
            <tr>
                <td bgColor="#e4e4e4" class="style12center">
                    <a target="_blank"
                        href="http://loops.usedcardboardboxes.com/hr_page.php?warehouse_id=556&onlyshow_timeclock=yes"><b>WRITE
                            TO HR</b></a>
                </td>
            </tr>
            <?php  } ?>
            ...
            <tr>
                <td bgColor="#e4e4e4" class="style12center">
                    <a
                        href="https://loops.usedcardboardboxes.com/hannibalwarehouse_141592653.php?onlyshow_timeclock=yes"><b>TIMECLOCK
                            COMPUTER PAGE</b></a>
                </td>
            </tr>
            <tr>
                <td bgColor="#e4e4e4" class="style12center">
                    <a
                        href="http://loops.usedcardboardboxes.com/report_timeclock_production_add.php?location_dd=2&show_data=Submit"><b>Add
                            Production</b></a>
                </td>
            </tr>
            <tr>
                <td bgColor="#e4e4e4" class="style12center">
                    <a
                        href="http://loops.usedcardboardboxes.com/search_results.php?id=504&proc=View&searchcrit=general mills&rec_type=Manufacturer&page=0"><b>General
                            Mills Hannibal Record</b></a>
                </td>
            </tr>
            <tr>
                <td bgColor="#e4e4e4" class="style12center">
                    <a href="http://loops.usedcardboardboxes.com/report_hannibal_inventory.php"><b>Physical Inventory
                            Report</b></a>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td bgColor="#e4e4e4" class="style12center">
                    <a target="_blank"
                        href="http://loops.usedcardboardboxes.com/report_inbound_inventory_summary.php?warehouse_id=556"><b><span
                                style="text-transform: uppercase;">Inbound Summary</span></b></a>
                </td>
            </tr>
            <tr>
                <td bgColor="#e4e4e4" class="style12center">
                    <a target="_blank" href="http://loops.usedcardboardboxes.com/hr_page.php?warehouse_id=556"><b>WRITE
                            TO HR</b></a>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td bgColor="#e4e4e4" class="style12center">
                    <a target="_blank"
                        href="report_search_processed_inbound_trailers.php?sorting_warehouse=556"><b>Search Processed
            ...
            <td colSpan="2" valign="top">
                    ...
                    <tr vAlign="center">
                        ...
                        <td bgColor="<?php echo isset($tablerow_color) ?>" class="style3" align="center">
                            ...
                            <div style="cursor: pointer;"
                                onclick="display_file('files/<?php echo $row["bol_filename"]; ?>', 'BOL')">
                        ...
                        <td align="left" bgColor="<?php echo isset($tablerow_color) ?>" class="style3">
                            <a target="_blank"
                                href="viewCompany.php?ID=<?php echo $b2bid ?>&show=transactions&warehouse_id=<?php echo $row["wid"] ?>&rec_type=Manufacturer&proc=View&searchcrit=&id=<?php echo $row["wid"] ?>&rec_id=<?php echo $row["rec_id"] ?>&display=seller_view"><?php echo getnickname($row["company_name"], $row["wid"]); ?></a>
                        </td>
                        <td align="center" bgColor="<?php echo isset($tablerow_color) ?>" class="style3">
                            <div id="dockdoor_<?php echo $row["rec_id"] ?>">
                                <input type=button value="Delivered to DOCK" style="cursor:pointer;"
                                    onclick="fn_delivered_to_dock('<?php echo $row["pr_trailer"]; ?>','<?php echo $row["rec_id"] ?>','false','<?php echo $wh_name; ?>')">
                            </div>
                        </td>
                        <td align="center" bgColor="<?php echo isset($tablerow_color) ?>" class="style3">
                            <input type=button value="Delivered to LOT" style="cursor:pointer;"
                                onclick="confirmationUcblot('<?php echo $row["pr_trailer"]; ?>',<?php echo $row["rec_id"] ?>,'<?php echo $row["pr_dock"]; ?>')">
                        </td>
                        <td align="center" bgColor="<?php echo isset($tablerow_color) ?>" class="style3">
                            <input type=button value="Recycling" style="cursor:pointer;"
                                onclick="confirmationRecycling('<?php echo $row["pr_trailer"]; ?>',<?php echo $row["rec_id"] ?>,'<?php echo $row["pr_dock"]; ?>')">
                        </td>
                    </tr>
                    <?php
                        }
                ...
                <table cellSpacing="1" cellPadding="1" border="0" width="700px;">
                    ...
                    <tr vAlign="center">
                        ...
                        <td align="left" bgColor="<?php echo $tablerow_color ?>" class="style3">
                            <a target="_blank"
                                href="viewCompany.php?ID=<?php echo $row["b2bid"] ?>&show=transactions&warehouse_id=<?php echo $row["warehouse_id"] ?>&rec_type=Manufacturer&proc=View&searchcrit=&id=<?php echo $row["warehouse_id"] ?>&rec_id=<?php echo $row["A"] ?>&display=seller_view"><?php echo getnickname($row["company_name"], $row["warehouse_id"]); ?></a>
                        </td>
                        <td align="center" bgColor="<?php echo $tablerow_color ?>" class="style3">
                            <div id="dockdoor_<?php echo $row["A"] ?>">
                                <input type=button value="Delivered to DOCK" style="cursor:pointer;"
                                    onclick="fn_delivered_to_dock('<?php echo $row["pr_trailer"]; ?>','<?php echo $row["A"] ?>','false', '<?php echo $wh_name; ?>')">
                            </div>
                        </td>
                        <td align="center" bgColor="<?php echo $tablerow_color ?>" class="style3">
                            <input type=button value="UnDo" style="cursor:pointer;"
                                onclick="undoucblot('<?php echo $row["pr_trailer"]; ?>',<?php echo $row["A"] ?>,'<?php echo $row["pr_dock"]; ?>')">
                        </td>
                    </tr>
                    <?php
                        }
                ...
                <table cellSpacing="1" cellPadding="1" border="0" width="700px;">
                    ...
                    <tr vAlign="center">
                        ...
                        <td align="center" bgColor="<?php echo $tablerow_color ?>" class="style3">
                            <input type=button value="Delivered" style="cursor:pointer;"
                                onclick="confirmationUnloaded('<?php echo $row["pr_trailer"]; ?>','<?php echo $row["A"] ?>','<?php echo $row["pr_dock"] ?>')">
                        </td>
                        <td align="center" bgColor="<?php echo $tablerow_color ?>" class="style3">
                            <input type=button value="UnDo" style="cursor:pointer;"
                                onclick="undorecycling('<?php echo $row["pr_trailer"]; ?>',<?php echo $row["A"] ?>,'<?php echo $row["pr_dock"]; ?>')">
                        </td>
                    </tr>
                    <?php
                        }
            ...
            <td vAlign="top">
                        ...
                        <tr align="center">
                            <td bgColor="<?php echo $tablerow_color ?>" class="style3" align="center">
                                ...
                                <div id="dockdoor_<?php echo $row["LTID"] ?>">
                                    <a href="#"
                                        onClick="fn_delivered_to_dock('<?php echo $row["pr_trailer"]; ?>','<?php echo $row["LTID"] ?>','true','<?php echo $wh_name; ?>')">
                                        Edit
                                    </a>
                                </div>
                            </td>
                            ...
                            <td align="left" bgColor="<?php echo $tablerow_color ?>" class="style3">
                                <a target="_blank"
                                    href="viewCompany.php?ID=<?php echo $b2bid ?>&show=transactions&warehouse_id=<?php echo $row["wid"] ?>&rec_type=Manufacturer&proc=View&searchcrit=&id=<?php echo $row["wid"] ?>&rec_id=<?php echo $rec_id ?>&display=seller_view"><?php echo getnickname($row["company_name"], $row["wid"]); ?></a>
                            </td>
                            <td bgColor="<?php echo $tablerow_color ?>" class="style3">
                                <?php if ($row["manulasortrep_print"] == "Y") { ?>
                                <input style="cursor:pointer;" type="button" value="Re-Print Report"
                                    onClick="printsortrep('<?php echo $row["LTID"] ?>' , '<?php echo $row["manulasortrep_print"]; ?>')">
                                <?php  } else { ?> <input type="button" value="Print Report"
                                    onClick="printsortrep('<?php echo $row["LTID"] ?>' , '<?php echo $row["manulasortrep_print"]; ?>')">
                                <?php  } ?>
                            </td>
                            <td align="center" bgColor="<?php echo $tablerow_color ?>" class="style3">
                                <input type=button value="UNLOADED" id="btnDelivered<?php echo $rec_id ?>"
                                    style="cursor:pointer;"
                                    onclick="confirmationUnloaded_new('<?php echo $row["pr_trailer"]; ?>','<?php echo $rec_id ?>','<?php echo $row["pr_dock"] ?>','556')">
                                <input type="hidden" name="hdnsortreportprintstatus_<?php echo $rec_id ?>"
                                    id="hdnsortreportprintstatus_<?php echo $rec_id ?>"
                                    value="<?php echo $row['manulasortrep_print']; ?>">
                            </td>
                            <td align="center" bgColor="<?php echo $tablerow_color ?>" class="style3">
                                <input type=button value="UnDo" style="cursor:pointer;"
                                    onclick="undoucbdockdoor('<?php echo $row["pr_trailer"]; ?>','<?php echo $rec_id ?>')">
                            </td>
                        </tr>
                        <?php
                            }
                ...
                <table cellSpacing="1" cellPadding="1" border="0" width="700px;">
                    ...
                    <tr vAlign="center">
                        ...
                        <td bgColor="<?php echo $tablerow_color ?>" class="style3">
                            <a target="_blank"
                                href="viewCompany.php?ID=<?php echo $row["b2bid"] ?>&show=transactions&warehouse_id=<?php echo $row["warehouse_id"] ?>&rec_type=Manufacturer&proc=View&searchcrit=&id=<?php echo $row["warehouse_id"] ?>&rec_id=<?php echo $row["LTID"] ?>&display=seller_view"><?php echo getnickname($row["company_name"], $row["warehouse_id"]); ?></a>
                        </td>
                        ...
                        <!-- Added by Mooneem 07-14-12  -->
                        <td bgColor="<?php echo $tablerow_color ?>" class="style3">
                            <INPUT style="cursor:pointer;" type="button" value="Enter Sort Report"
                                onClick="window.open('viewCompany-purchasing.php?ID=<?php echo  $row["b2bid"]; ?>&show=transactions&warehouse_id=<?php echo  $row["warehouse_id"]; ?>&rec_type=Manufacturer&proc=View&searchcrit=&id=<?php echo  $row["warehouse_id"]; ?>&rec_id=<?php echo  $row["LTID"]; ?>&display=seller_sort')">
                            <!-- Email davidkrasnow@usedcardboardboxes.com -->
                        </td>
                        <td align="center" bgColor="<?php echo $tablerow_color ?>" class="style3">
                            <input type=button value="UnDo" style="cursor:pointer;"
                                onclick="undodelivery('<?php echo $row["pr_trailer"]; ?>',<?php echo $row["LTID"] ?>,'<?php echo $row["pr_dock"]; ?>')">
                        </td>
                    </tr>
                    <?php
                        }
    ...
    <table>
        <tr>
                ...
                <table cellSpacing="1" cellPadding="1" border="0" width="700px;">
                    ...
                    <tr vAlign="center">
                        ...
                        <td bgColor="#e4e4e4" class="style3" align="center">
                            <u>
                                <a target="_blank"
                                    href="viewCompany-purchasing.php?ID=<?php echo $b2b_id ?>&show=transactions&warehouse_id=<?php echo $row["wid"] ?>&rec_type=Manufacturer&proc=View&searchcrit=&id=<?php echo $row["wid"] ?>&rec_id=<?php echo $row["trid"] ?>&display=seller_sort"><?php echo $row["warehousename"]; ?></a>
                            </u>
                        </td>
                        <?php } else { ?>
                        <td bgColor="#e4e4e4" class="style3" align="center">
                            <p align="center">
                                <span class="infotxt_freight ">
                                    <u><a target="_blank"
                                            href="http://loops.usedcardboardboxes.com/search_results.php?warehouse_id=<?php echo $row["wid"] ?>&rec_type=Supplier&proc=View&searchcrit=&id=<?php echo $row["wid"] ?>&rec_id=<?php echo $row["trid"]; ?>&display=buyer_ship"><?php echo $row["warehousename"]; ?></a></u>
                        ...
                        <?php } else {
                                    ...
                                    ?>
                        <td bgColor="red" class="style3" align="center">
                            <font color="white"><?php echo $row["date"]; ?></font>
                        </td>
                        <?php
                                    } else if ($fr_book_dt == $today_date) {
                                    ?>
                        <td bgColor="yellow" class="style3" align="center">
            ...
            <td bgColor="#e4e4e4" class="style3" align="center">
                <a href="#"
                    onClick="PrintPickListRep('<?php echo $row["trid"] ?>' , '<?php echo $row["picklist_print"]; ?>')">Re-Print
                    Picklist</a>
            </td>
            <?php  }
            ...
            <td bgColor="#e4e4e4" class="style3" align="center">
                <a href="#"
                    onClick="PrintPickListRep('<?php echo $row["trid"] ?>' , '<?php echo $row["picklist_print"]; ?>')">Print
                    Picklist</a>
            </td>
            <?php  } ?>
        </tr>
    ...
    <table cellSpacing="1" cellPadding="1" border="0" width="700px;">
        ...
        <tr class="<?php echo $bgclass; ?>" id="so<?php echo $rows["wid"] ?>">
            <td class="style3">
                <a href="viewCompany.php?ID=<?php echo $rows["b2bid"] ?>&show=transactions&warehouse_id=<?php echo $rows["warehouse_id"] ?>&rec_type=Supplier&proc=View&searchcrit=&id=<?php echo $rows["warehouse_id"] ?>&rec_id=<?php echo $rows["wid"] ?>&display=buyer_view"
                    target="_blank"><?php echo $rows["wid"]; ?></a>
            </td>
            <td class="style3">
                <span class="so_infotxt">
                    <a href="viewCompany.php?ID=<?php echo $rows["b2bid"] ?>&show=transactions&warehouse_id=<?php echo $rows["warehouse_id"] ?>&rec_type=Supplier&proc=View&searchcrit=&id=<?php echo $rows["warehouse_id"] ?>&rec_id=<?php echo $rows["wid"] ?>&display=buyer_view"
                        target="_blank"> <?php echo $rows["warehouse_name"]; ?></a>
                    <!--Display sales order popup on hover-->
                    <span style="width:570px;">
                        <table cellSpacing="1" cellPadding="1" border="0" width="570">
                            <tr align="middle">
                                <td class="style7" colspan="3" style="height: 16px"><strong>SALE ORDER DETAILS FOR ORDER
                                        ID: <?php echo $rows["wid"] ?></strong></td>
                            </tr>
                            <tr vAlign="center">
                                <td bgColor="#e4e4e4" width="70" class="style17">
                                    <font size=1>
            ...
            <td class="style3">
                <?php
                        ...
                        echo $deadlinedate; ?>
                <input type="hidden" name="deadlinedate" id="deadlinedate<?php echo $rows["wid"]; ?>"
            ...
            <td class="style3" align="center">
                <a href="#"
                    onClick="PrintPickListRep_so('<?php echo $rows["wid"]; ?>' , '<?php echo $rows["picklist_print"]; ?>')">Re-Print
                    Picklist</a>
            </td>
            <?php  }
            ...
            <td class="style3" align="center">
                <a href="#"
                    onClick="PrintPickListRep_so('<?php echo $rows["wid"]; ?>' , '<?php echo $rows["picklist_print"]; ?>')">Print
                    Picklist</a>
            </td>
            <?php  }
                    ?>
            <input type="hidden" name="pprintdata" id="pprintdata<?php echo $rows["wid"] ?>"
                value="<?php echo $pprint; ?>">
            <td class="style3">
                <textarea name="last_note_so"
                    id="last_note_so<?php echo $rows["wid"]; ?>"><?php echo isset($lastnote_text); ?></textarea>
            </td>
            <td class="style3">
            ...
            <td class="style3" align="center">
                <input type="hidden" name="rect_type_so" id="rect_type_so<?php echo $rows["wid"] ?>"
                    value="<?php echo $rec_type; ?>">
                <input type="button" name="update_so" id='update_so<?php echo $rows["wid"] ?>'
                    onclick="update_so_note(<?php echo $rows["wid"] ?>,<?php echo $rows["warehouse_id"]; ?>,<?php echo $emp_id; ?>); return false;"
                    value="Update">
            ...
            <td class="style3" align="center">
                <div id="complete_so_div<?php echo $rows["wid"] ?>">
                    <?php
                            ...
                            ?>
                    <input type="button" name="complete_so" id='complete_so<?php echo $rows["wid"] ?>'
                        onclick="complete_specialorder_row(<?php echo $rows["wid"] ?>,<?php echo $rows["warehouse_id"]; ?>,1); return false;"
                        value="Complete">
                    <?php
                            }
                            ...
                            ?>
                    Completed<br>
                    <input type="button" name="undo_complete_so" id='undo_complete_so<?php echo $rows["wid"] ?>'
                        onclick="complete_specialorder_row(<?php echo $rows["wid"] ?>,<?php echo $rows["warehouse_id"]; ?>,0); return false;"
                        value="Undo">
                    <?php
                            }
                            ?>
            ...
            <td>
                ...
                <table cellSpacing="1" cellPadding="1" width="550" border="0">
                    ...
                    <tr vAlign="center">
                        ...
                        <td bgColor="#e4e4e4" class="style3" align="center">
                            <a href="http://loops.usedcardboardboxes.com/mccormickdashboard.php?action=run&start_date=<?php echo htmlspecialchars($_REQUEST["start_date"]); ?>&end_date=<?php echo $_REQUEST["end_date"]; ?>&surveyview=<?php echo $_REQUEST["surveyview"]; ?>&trailer=<?php echo $row["id"]; ?>&trlsub=1"
            ...
            if ($_REQUEST["trailer"] > 0) {
                ...
                <table cellSpacing="1" cellPadding="1" border="0" width="800">
                    ...
                    <tr>
                        ...
                        <td bgColor="#e4e4e4" class="style12right"><?php echo $dt_view_row["sort_boxgoodvalue"]; ?>
                        </td>
    ...
    <div id="diveod" style="display:none;">
        <form action="<?php echo hannibalwarehousepage(); ?>" name="frmeod" id="frmeod" method="post">
            <table>
                ...
                <tr>
                    <td>Enter No. of Qty of Kits Shipped Today: &nbsp;<input type="text" name="qtyofkitship"
                            id="qtyofkitship" value="" /></td>
                </tr>
                <tr>
