...
$wid = 1503;
$carrier_name = "Brunozzi Transfer";
$destination_id = 2; //This is in loop_mccormick_dock
$title_name = "Pepsi, Philadelphia - Dashboard";
$return_url = "dashboard_PEPPHI_66438728418847844.php";
$items = 8;
                    ...
                    <TABLE ALIGN='LEFT' width="450">
                        ...
                        <TR>
                            ...
                            <TD bgColor="#e4e4e4" class="style12" CLASS='TBL_ROW_HDR' style="text-align: left">
                                <font size="2" face="Arial">
                                    Pallets of Reusable Boxes<input type="hidden" name="item_1"
                                        value="Pallets of Reusable Boxes">
                                </font>
                            </TD>
                        </TR>
                        <TR>
                        ...
                        <TR>
                            ...
                            <TD bgColor="#e4e4e4" class="style12">
                                <font face="Arial">
                                    <input name="count_6" size=10 style="float: left" id="count_6"
                                        onchange="update_cart()">
                                </font>
                                <font size="2" face="Arial">
                                </font>
                        ...
                        <TR>
                            ...
                            <TD bgColor="#e4e4e4" class="style12">
                                <font face="Arial">
                                    <input name="count_7" size=10 style="float: left" id="count_7"
                                        onchange="update_cart()">
                                </font>
                                <font size="2" face="Arial">
                                </font>
                        ...
                        <TR>
                            ...
                            <TD bgColor="#e4e4e4" class="style12">
                                <font face="Arial">
                                    <input name="count_8" size=10 style="float: left" id="count_8"
                                        onchange="update_cart()">
                                </font>
                                <font size="2" face="Arial">
                                </font>
