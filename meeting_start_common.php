					 ...
					 <div class="col-md-12 form-group">
					  ...
					  <div class="col-md-12 form-group issue_div_start_meeting">
						...
						<select class="form-control form-control-sm select2" id="copy_to_meeting" name="copy_to_meeting">
                            <?php
                            db_project_mgmt();
                               $sql_main =db_query("SELECT * FROM meeting_master where status = 1 && id!=0 && id!=".$_COOKIE['meeting_id']." ORDER BY id DESC");
...
<script>
    var pause_live_data=false;
        ...
        $('#addNewProjectMeet').click(function(){
            var meeting_id='<?php echo $_COOKIE['meeting_id']?>';
            ...
            $.ajax({
                ...
                async:false,
                beforeSend: function () {
                    $('#searchExistingProject').html('<option value="0" data-kt-rich-content-icon=""  data-kt-rich-content-emp-txt="">Loading.....</option>');
                },
                success:function(response){
