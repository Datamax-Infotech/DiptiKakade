...
$wid = 2297;                                                           //This is the Rescue Loops ID number of the record you want to attach to this portal
$carrier_name = "Gerber";                                            //This is the name of the freight provider that will be doing the pickup of the trailer
$destination_id = 1;                                                 //This is the ID number from loop_mccormick_dock which is used for the BOL Ship To address
$title_name = "McCormick & Company, Inc. TIC - Hunt Valley, MD - Dashboard";         //This is the html title of the page
$return_url = "dashboard_mcTIC_7985416485.php";                        //This is the file name of this report, Save as...
$items = 5;                                                            //This is the total number of items on the BOL creator + 2 blank entries
        ...
        <tr>
            ...
            <td align=center colspan="3">
                <font face="Ariel" size="5">
                    ...
                    <b><i><?php echo isset($warehouse_name); ?> - TIC</i></b>
                    </i>
            </td>
                ...
                <FORM METHOD="POST" ACTION="BOLpickupsubmitNEW.php" name="BOL" id="BOL">
                    ...
                    <TABLE ALIGN='LEFT' width="450">
                        ...
                        <TR>
                            ...
                            <!--Start of the BOL Creator Line Items, edit the below-->
                        ...
                        <TR>
                            ...
                            <TD bgColor="#e4e4e4" class="style12" CLASS='TBL_ROW_HDR' style="text-align: left">
                                <font size="2" face="Arial">
                                    Trash Dumpster<input type="hidden" name="item_1" value="Trash Dumpster">
                                </font>
                            </TD>
                        </TR>
                        ...
                        <TR>
                            ...
                            <TD bgColor="#e4e4e4" class="style12" CLASS='TBL_ROW_HDR' style="text-align: left">
                                <font size="2" face="Arial">
                                    Recycling Dumpster<input type="hidden" name="item_2" value="Recycling Dumpster">
                                </font>
                            </TD>
                        </TR>
                        <TR>
                            ...
                            <TD bgColor="#e4e4e4" class="style12" CLASS='TBL_ROW_HDR' style="text-align: left">
                                <font size="2" face="Arial">
                                    Compost Bins<input type="hidden" name="item_3" value="Compost Bins">
                                </font>
                            </TD>
                        </TR>

                        <!--End of the BOL Creator Line Items, edit the above-->
