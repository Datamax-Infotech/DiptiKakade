                            ...
                            <div class="card shadow p-4">
                                <div class="row">
                                    ...
                                    <div class="py-2 col-md-12">
                                        <?php
                                        db_project_mgmt();
                                        $task_sql=db_query("SELECT task_status,task_master.id,task_duedate,task_title,task_entered_by,task_entered_on,task_assignto,added_during_meeting FROM task_master where (task_master.task_status = 0) and task_meeting=$meeting_id and archive_status=0 ORDER BY id DESC");
