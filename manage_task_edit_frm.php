...
db();
$sql = db_query("SELECT * FROM task_master WHERE id =" . $_REQUEST['id']);
$row = array_shift($sql);
?>
    ...
    <div class="left_frm py-50">
        <div class="user__details">
            ...
            <div class="full_input__box">
                ...
                <input type="text" name="task_title" id="task_title" value="<?php echo $row["task_title"]; ?>">
            </div>
            <div class="full_input__box">
                ...
                $FCKeditor->Value = $row["task_details"];
            ...
            <div class="input__box">
                ...
                <select id="assignto" name="assignto" width="100%">
                    ...
                    while ($myrowsel = array_shift($result)) {
                        ...
                        if ($myrowsel["employeeID"] == $row["task_assignto"]) echo " selected ";
            ...
            <div class="input__box">
                ...
                <div class="light_calbox123" style="display:relative;">
                    <input type="text" name="duedate" id="duedate" size="20" readonly
                        value="<?php echo $row["task_duedate"]; ?>" class="dateinput_frm">
            ...
            <div class="input__box">
                ...
                <select id="task_priority" name="task_priority" width="100%">
                    <option value="Low" <?php if ($row["task_priority"] == "Low") echo "selected"; ?>>Low</option>
                    <option value="Medium" <?php if ($row["task_priority"] == "Medium") echo "selected"; ?>>Medium
                    </option>
                    <option value="High" <?php if ($row["task_priority"] == "High") echo "selected"; ?>>High</option>
                </select>
            </div>
            ...
            <div class="input__box">
                ...
                <input type="hidden" name="task_Edit" value="EDIT">
            ...
            <div class="button_box" style="text-align: right;">
                ...
                <input type="submit" value="SAVE" name="submit" style="cursor:pointer;" class="button_frm"
                    onclick="return frm_edit_task_chk()">&nbsp;
                <input type="button" value="RESET" onclick="resetctrls()" style="cursor:pointer;" class="button_frm">
            </div>
