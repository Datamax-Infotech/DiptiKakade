                    ...
                    <div class="container-fluid  mt-0 mb-3">
                        <div class="row justify-content-center mt-4">
                            ...
                            <div class="col-md-10">
                                <?php
                                db_project_mgmt();
                                db_query("UPDATE meeting_live_updates set project_flg=0 where meeting_timer_id='" . $_COOKIE['meeting_timer_id'] . "' && attendee_id='" . $_COOKIE['b2b_id'] . "'");
                                $project_sql = db_query("SELECT project_id,project_name,project_status_id,project_deadline,project_owner FROM project_master where find_in_set($meeting_id,meeting_ids) and archive_status = 0 ORDER BY project_id DESC");
                                $no_data_div = "d-none";
                                    ...
                                    <div class="col-md-4">
                                        <div class="card">
                                            ...
                                            <?php } ?>
                                                                ...
                                                                <?php echo getMeetingEmployeeWithImgForMeetingForms("meeting_owner_id", "owner_id", $meeting_id); ?>
                                                                <?php //echo getAllEmployeeWithImgForMeetingForms("meeting_owner_id","owner_id");
                                                                ?>
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('change', '.meeting_pstatus_select', function() {
                ...
                var current_ele = $(this);
                var data = {
                    "update_meeting_project_status": 1,
                    pstatus_id,
                    project_id,
