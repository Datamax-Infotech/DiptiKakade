...
db();
$getdata = db_query("Insert into loop_transaction_buyer_ship_eml_data(trans_rec_id, broker_needs_pickup_email_flg, broker_needs_pickup_email_sendby, broker_needs_pickup_email_sendon) select " . $_REQUEST["rec_id"] . ", 1, '" . $_COOKIE['userinitials'] . "', '" . date("Y-m-d H:i:s") . "'");
