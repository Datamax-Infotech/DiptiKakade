...
<head>
    ...
    <title>Hanover Foods - Dashboard</title>
...
<body>
    ...
    <table>
        <tr>
            <td>
                <?php
                $query = "SELECT * FROM loop_warehouse WHERE id = 185";
                db();
                $res = db_query($query);
        ...
        <tr>
            <td valign="top">
                ...
                <FORM METHOD="POST" ACTION="BOLpickupsubmitNEW.php" name="BOL" id="BOL">
                    <input type=hidden value="Semi Express" name="carrier">
                    <input type=hidden value="185" name="warehouse_id">
                    <input type=hidden value="dashboard_HF_8628996208.php" name="return_url">
                    <?php
                    $query = "SELECT * FROM loop_warehouse WHERE id = 185";
                    db();
                    $res = db_query($query);
                    ...
                    <TABLE ALIGN='LEFT' width="450">
                        ...
                        <TR>
                            ...
                            <TD bgColor="#e4e4e4" class="style12" CLASS='TBL_ROW_HDR' style="text-align: left">
                                <font size="2" face="Arial">
                                    Once Used Totes<input type="hidden" name="item_1" value="Once Used Totes">
                                </font>
                            </TD>
                        </TR>
                        <TR>
                            ...
                            <TD bgColor="#e4e4e4" class="style12" CLASS='TBL_ROW_HDR' style="text-align: left">
                                <font size="2" face="Arial">
                                    Multi-Use Totes<input type="hidden" name="item_2" value="Multi-Use Totes">
                                </font>
                            </TD>
                        </TR>
                        <TR>
                            ...
                            <TD bgColor="#e4e4e4" class="style12" CLASS='TBL_ROW_HDR' style="text-align: left">
                                <font size="2" face="Arial">
                                    HPT-34 Totes<input type="hidden" name="item_3" value="HPT-34 Totes">
                                </font>
                            </TD>
                        </TR>
                        <TR>
            ...
            <td valign="top">
                ...
                <table cellSpacing="1" cellPadding="1" border="0">
                    ...
                    <?php
                    $query = "SELECT * FROM loop_transaction WHERE warehouse_id = 185 AND pa_employee LIKE '' AND cp_employee LIKE '' ORDER BY ID ASC";
                    db();
                    $res = db_query($query);
                    while ($row = array_shift($res)) {
    ...
    <table cellSpacing="1" cellPadding="1" border="0">
        ...
        <?php
        $query = "SELECT * FROM loop_transaction WHERE warehouse_id = 185 AND (pa_employee NOT LIKE '' OR bol_employee NOT LIKE '') AND sort_entered = 0 ORDER BY ID ASC";
        db();
        $res = db_query($query);
        while ($row = array_shift($res)) {
    ...
    <form name="rptSearch" action="processedtrailerreporttrl.php" method="POST" target="_blank">
        ...
        <input type="hidden" name="warehouse_id" value="185">
        <span class="style2">
        ...
        <tr>
            <td>
                ...
                <table cellSpacing="1" cellPadding="1" width="550" border="0">
                    ...
                    <?php
                        $query = "SELECT * FROM loop_transaction WHERE warehouse_id = 185 AND";
