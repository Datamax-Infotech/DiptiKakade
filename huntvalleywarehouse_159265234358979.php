    ...
    <script LANGUAGE="JavaScript">
        ...
        function confirmationRequest(a, b, c) {
            ...
            if (answer) {
                ...
                window.location = "<?php echo huntvalleywarehousepage() ?>?action=request&req_id=" + b + "&trailer_no=" + a +
                    "&dock=" + c;
        ...
        function confirmationRecycling(a, b, c) {
            ...
            if (answer) {
                ...
                window.location = "<?php echo huntvalleywarehousepage() ?>?action=recycling&conf_id=" + b + "&trailer_no=" +
                    a + "&dock=" + c;
        ...
        function confirmationUcblot(a, b, c) {
            ...
            if (answer) {
                ...
                window.location = "<?php echo huntvalleywarehousepage() ?>?action=ucblot&conf_id=" + b + "&trailer_no=" + a +
                    "&dock=" + c;
...
<body onload="JavaScript:timedRefresh(1200000);">
    ...
    <?php
    $worker_selected = ""; // Moved to new position - Siddhesh
    $efficiency      = 0; // Moved to new position - Siddhesh
    $tot_production  = 0; // Moved to new position - Siddhesh
    $money_lost_tot  = 0; // Moved to new position - Siddhesh
    $tablerow_color  = ""; // Moved to new position - Siddhesh
    $oldestdate      = ""; // Moved to new position - Siddhesh
    $trs_id          = ""; // Moved to new position - Siddhesh
    $b2b_id          = ""; // Moved to new position - Siddhesh
    $pprint          = ""; // Moved to new position - Siddhesh
    $lastnote_text   = ""; // Moved to new position - Siddhesh
    $start_date      = ""; // Moved to new position - Siddhesh
    $end_date        = ""; // Moved to new position - Siddhesh
    $oldest_date     = ""; // Moved to new position - Siddhesh
    ...
    <table border="0">
                ...
                <form method="post" action="<?php echo huntvalleywarehousepage() ?>" onsubmit="return chkssn();">
                    ...
                    <table cellSpacing="1" cellPadding="1" border="0" width="700px;">
                        ...
                        <tr vAlign="center">
                            ...
                            <?php
                            $date1 = mktime(date("H") + 3, (int) date("i"), (int) date("s"), (int) date("m"), (int) date("d"), (int) date("Y"));
        ...
        <tr vAlign="center">
            ...
            <td bgColor="#e4e4e4" align=middle class="style3" width="250px;">
                SSN (last 4 digit) <input type="password" name="ssn_txt_logout" id="ssn_txt_logout<?php if (isset($row["A"])) {
                                                                                                        echo $row["A"];
                                                                                                    } else {
                                                                                                        echo "";
                                                                                                    } ?>" value="" size="4" />
    ...
    <td valign="top">
        ...
        <?php if ($onlyshow_timeclock == "no") { ?>
            <table cellSpacing="1" cellPadding="1" border="0" width="500px;">
                ...
                // Assuming $arrLeaderboardHunvalley is defined and populated
                ...
                ?>
                    <tr vAlign="center">
                        ...
                        <td bgColor="#e4e4e4" class="style3" align="center">
                            <?php
                            // $money_lost = str_replace(",", "", number_format($arrLeaderboardHunvalleyV["production"],2)) - (floatval(str_replace(",", "", number_format($arrLeaderboardHunvalleyV["hourrate"],2))) * floatval(str_replace(",", "", number_format($arrLeaderboardHunvalleyV["totalhours"],2))));
                            $production = floatval(str_replace(",", "", number_format($arrLeaderboardHunvalleyV["production"], 2)));
                            $hourrate = floatval(str_replace(",", "", number_format($arrLeaderboardHunvalleyV["hourrate"], 2)));
                            $totalhours = floatval(str_replace(",", "", number_format($arrLeaderboardHunvalleyV["totalhours"], 2)));

                            $money_lost = $production - ($hourrate * $totalhours);
    ...
    <td valign="top">
        ...
        <table cellSpacing="1" cellPadding="1" border="0" width="200">
            ...
            <?php if ($onlyshow_timeclock == "yes") { ?>
                <tr>
                    <td bgColor="#e4e4e4" class="style12center">
                        <a target="_blank" href="http://loops.usedcardboardboxes.com/hr_page.php?warehouse_id=18&onlyshow_timeclock=yes"><b>WRITE
                                TO HR</b></a>
                    </td>
                </tr>
            <?php } ?>
            <?php if ($onlyshow_timeclock == "no") { ?>
                <tr>
                    <td bgColor="#e4e4e4" class="style12center">
                        <a href="https://loops.usedcardboardboxes.com/huntvalleywarehouse_159265234358979.php?onlyshow_timeclock=yes"><b>TIMECLOCK
                                COMPUTER PAGE</b></a>
                    </td>
                </tr>
                <tr>
                        ...
                        <script LANGUAGE="JavaScript">
                            ...
                            function undodelivery(trailerno, recid, dockno) {
                                ...
                                if (answer) {
                                    ...
                                    window.location = "<?php echo huntvalleywarehousepage() ?>?action=undodelivery&conf_id=" +
                            ...
                            function undorecycling(trailerno, recid, dockno) {
                                ...
                                if (answer) {
                                    ...
                                    window.location = "<?php echo huntvalleywarehousepage() ?>?action=undorecycling&conf_id=" +
                                        recid + "&trailer_no=" + trailerno + "&dock=" + dockno;
                            ...
                            function undoucblot(trailerno, recid, dockno) {
                                ...
                                if (answer) {
                                    ...
                                    window.location = "<?php echo huntvalleywarehousepage() ?>?action=undoucblot&conf_id=" +
                                        recid + "&trailer_no=" + trailerno + "&dock=" + dockno;
                            ...
                            function undoucbdockdoor(trailerno, recid) {
                                ...
                                if (answer) {
                                    ...
                                    window.location = "<?php echo huntvalleywarehousepage() ?>?action=undoucbdockdoor&conf_id=" +
                                        recid + "&trailer_no=" + trailerno;
    ...
    if ($_REQUEST["action"] == 'run') {
        ...
        $start_date = date('Ymd', strtotime($start_date) ?: time());
                ...
                ?>
                    <table cellSpacing="1" cellPadding="1" border="0" width="800">
                        ...
                        <tr>
                            ...
                            <td bgColor="#e4e4e4" class="style12right"><strong><?php echo number_format($gbw, 2); ?></strong>
                            </td>
                            <td bgColor="#e4e4e4" class="style12"> </td>
                            <td bgColor="#e4e4e4" class="style12right"><strong>$<?php echo number_format($vob, 2); ?></strong>
                            </td>
                        </tr>
                        <tr align="middle">
                        ...
                        <tr>
                            ...
                            <td bgColor="#e4e4e4" class="style12right"><strong>$<?php echo number_format($voo, 2); ?></strong>
                            </td>
                        </tr>
                        <tr align="middle">
