        ...
        <div class="container-fluid meeting_vto  p-4 my-2 " id="meeting_vto_div" >
            <div class="card p-5">
                ...
                <?php
                        ...
                        $vto_data_sql = db_query("SELECT * FROM meeting_vto where meeting_id = $meeting_id");
                        ...
                        if(tep_db_num_rows($vto_data_sql) > 0){
                            ...
                            VALUES('$meeting_id','$goals_for_year_title','$goals_for_the_year','$quarterly_rock_title','$quarterly_rock','$vto_issue_title','$vto_issue','".$_COOKIE['b2b_id']."','".date("Y-m-d h:i:s")."')");
                ...
                <div class="row justify-content-center">
                    <div class="col-md-6 mt-2">
                        <div class="vto-header"><a id="goal_title" class="<?php echo $vto_edit_class; ?> vto-header-input" href="javascript:open_popup_meeting_vto(<?php echo $vto_id;?>,'edit_goal')"><?php echo $goals_for_year_title;?></a></div>
                        <div><a id="goals_for_the_year" class="<?php echo $vto_edit_class; ?>" href="javascript:open_popup_meeting_vto(<?php echo $vto_id;?>,'edit_goal')"><?php echo $goals_for_the_year?></a></div>
                    </div>
                    <div class="col-md-6 mt-2">
                        <div class="vto-header"><a id="quarterly_rock_title" class="<?php echo $vto_edit_class; ?> vto-header-input" href="javascript:open_popup_meeting_vto(<?php echo $vto_id;?>,'edit_rock')"><?php echo $quarterly_rock_title;?></a></div>
                        <div><a id="quarterly_rock" class="<?php echo $vto_edit_class; ?>" href="javascript:open_popup_meeting_vto(<?php echo $vto_id;?>,'edit_rock')"><?php echo $quarterly_rock?></a></div>
                    </div>
                    <div class="col-md-12 mt-5">
                        <div class="vto-header"><a id="vto_issue_title" class="<?php echo $vto_edit_class; ?> vto-header-input" href="javascript:open_popup_meeting_vto(<?php echo $vto_id;?>,'edit_issue')"><?php echo $vto_issue_title;?></a></div>
                        <div><a id="vto_issue" class="<?php echo $vto_edit_class; ?>" href="javascript:open_popup_meeting_vto(<?php echo $vto_id;?>,'edit_issue')"><?php echo $vto_issue;?></a></div>
                    </div>
                </div>
                <?php } ?>
            </div>
	...
	<script>
        ...
        function open_popup_meeting_vto(id,edit_type){
            $.ajax({
                ...
                type:'get',
                data:{'edit_meeting_vto':1,id,edit_type, meeting_id:'<?php echo $meeting_id;?>'},
                datatype:'json',
