					...
					<div class="row">
					 ...
					 <div class="col-md-12 form-group">
					  ...
					  <div class="col-md-12 form-group owner_div_start_meeting">
                        ...
                        <?php echo getAllEmployeeWithImgForMeetingForms("addOwnerStartMeet", "issue_owner"); ?>
					  </div>
					</div>	 
				</div>
			...
			<form action="task_action.php" method="post" name="form_task_start_meet" id="form_task_start_meet"  onsubmit="return false;">
				...
				<div class="row">
					 ...
					 <div class="col-md-6 form-group">
						  ...
						  <input type="date" class="form-control form-control-sm" placeholder="" name="task_duedate" id="task_duedate_start_meet" value="<?php echo $oneWeekFromToday; ?>">
...
<script>
    ...
    var pause_live_data=false;
        ...
        $('#add_existing_project').submit(function(){
            ...
            $.ajax({
                url:'project_action.php',
                type:'post',
                data:{'add_existing_project_meeting':2, project_id,meeting_id,meeting_timer_id:"<?php echo $meeting_timer_id; ?>"},
                datatype:'json',
                async:false,
                beforeSend: function () {
            ...
            $.ajax({
                ...
                beforeSend: function () {
                    ...
                    complete:function () {
                        ...
                        $('#task_duedate_start_meet').val('<?php echo$oneWeekFromToday; ?>'); 
    ...
    function displayIssueDataAfterMeetingAction(res){
        if(res.data.length==0){
            ...
            $.each(res.data,function(k,data){
                console.log("Inside displayIssueDataAfterMeetingAction");
                console.log(data);
    ...
    function getAttendeeOfCurrentMeeting(){
        $.ajax({
            ...
            type:'get',
            data:{'fetch_attendee_of_meeting':1, 'meeting_id':"<?php echo $meeting_id; ?>"},
            datatype:'json',
            async:false,
            success:function(response){
                ...
                $.each(res,function(k,v){
                  var selected_user=v.emp_b2b_id == '<?php echo $_COOKIE['b2b_id'] ?>' ? "selected ": "";
    ...
    $("#copy_form_issue_start_meet").submit(function(e){
        ...
        $('.change_meeting_page').click(function(){
            ...
            $.ajax({
                url:'dashboard_meeting_action.php',
                type:'get',
                data:{page_type,page_change_action:"update_page_change",current_page,'meeting_timer_id':"<?php echo $meeting_timer_id?>",'meeting_id':"<?php echo $meeting_id?>"},
                datatype:'html',
                async:false,
                success:function(response){  
        ...
        $(document).ready(function(){
            ...
            $.ajax({
                url:'dashboard_meeting_action.php',
                type:'get',
                data:{update_page_refresh:1,current_page,'meeting_timer_id':"<?php echo $meeting_timer_id?>",'meeting_id':"<?php echo $meeting_id?>"},
                success:function(response){
                },
            ...
            function getUpdatesFromLiveChanges(){
                ...
                $.ajax({
                    url:'dashboard_meeting_action.php',
                    type:'get',
                    data:{get_live_data_of_meeting:1,meeting_id:"<?php echo $meeting_id?>", meeting_timer_id:"<?php echo $meeting_timer_id;?>"},
                    datatype:'html',
                    success:function(response){
                    var res=JSON.parse(response);
                    ...
                    if(res.owner_page_flg==1){
                        ...
                        var page_id="";
                        window.location.href=res.owner_current_page+'?meeting_id='+'<?php echo$_GET['meeting_id']?>'+'&meeting_timer_id='+'<?php echo$_GET['meeting_timer_id']?>';
        ...
        function display_time_count(){
            ...
            $.ajax({
                url:'dashboard_meeting_action.php',
                type:'get',
                data:{update_owner_page_time_counter:1,table_page_id,'time_spent':time_spent_on_page,meeting_timer_id:"<?php echo $meeting_timer_id;?>"},
                success:function(response){
