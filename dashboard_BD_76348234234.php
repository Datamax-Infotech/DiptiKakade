...
if ($_REQUEST["action"] == "clockin") {
	if ($_REQUEST["worker"] > 0) {
		...
		$sql3ud = "INSERT INTO loop_timeclock (`worker_id` ,`warehouse_id` ,`time_in`, `type`, `ipaddress`) VALUES ('" . $_REQUEST["worker"] . "', '79', NOW() + INTERVAL 1 HOUR, '" . $_REQUEST["type"] . "', '" . $_SERVER["REMOTE_ADDR"] . "')";
	...
	<FORM METHOD="POST" ACTION="BOLpickupsubmitNEW.php">
		...
		<table class="tbl_align_left table_w_450">
			...
			<TR>
				...
				<TD class="style12 bg_color_e4e4e4 TBL_ROW_HDR" style="text-align: left">
					<span class="font_size_2 font_face_Arial">
						<input type=text size="55" value="Other: Check box &amp; replace text with item description" name="item_2">
					</span>
				</TD>
			</TR>
			<TR>
				...
				<TD class="style12 bg_color_e4e4e4 TBL_ROW_HDR" style="text-align: left">
					<span class="font_size_2 font_face_Arial">
						<input type=text size="55" value="Other: Check box &amp; replace text with item description" name="item_3">
					</span>
				</TD>
			</TR>
			<TR>
				...
				<TD class="style12 bg_color_e4e4e4 TBL_ROW_HDR" style="text-align: left">
					<span class="font_size_2 font_face_Arial">
						<input type=text size="55" value="Other: Check box &amp; replace text with item description" name="item_4">
					</span>
				</TD>
			</TR>
			<TR>
