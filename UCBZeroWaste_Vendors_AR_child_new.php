...
<table width="60%" border="0" cellspacing="1" cellpadding="1">
    ...
    if (isset($_REQUEST["vendors_dd"])) {
        if ($_REQUEST["vendors_dd"] != "All" && $_REQUEST["vendors_dd"] != "") {
            $vendorQry = "Select *, water_transaction.id as transid, loop_warehouse.id as warehouse_id, sum(amount) as amt, loop_warehouse.company_name, loop_warehouse.b2bid, water_transaction.id as transid 
					...
					water_transaction.id having sum(amount) > 0 $vendorsQry_order" . $pagination_string;
            //water_vendors_payable_contact.id as receivable_id	left join water_vendors_payable_contact on water_transaction.vendor_id=water_vendors_payable_contact.water_vendor_id
    ...
    <tr>
        ...
        <td bgcolor="<?php echo isset($bgcolor); ?>" class="display_table"><a target="_blank"
                href="viewCompany.php?ID=<?php echo $rows[" b2bid"];
                                                                                                                            ?>&proc=View&searchcrit=&show=watertransactions&rec_type=Manufacturer">
        ...
        <td class="display_table" id="payment_method_td-<?php echo  $unique_count; ?>">
            <?php echo $payable_payment_terms_accepted_by_ucbzerowaste; ?>
        </td>
                    ...
                    <div id="editSectionTbl_<?php echo  $unique_count ?>">
                        ...
                        <table width="300px">
                            ...
                            <tr>
                                ...
                                <td class="display_table">
                                    <input type="text" name="paid_date" id="paid_date<?php echo  $unique_count; ?>"
                            ...
                            <tr>
                                ...
                                <td class="display_table">
                                    <select id="payment_method_new" name="payment_method_new">
                                        ...
                                        <option value="ePayment/EFT: credit to Chase account" <?php if ($rows["payment_method_new"] == "ePayment/EFT: credit to Chase account") {
                                                                                                        echo " selected ";
                                                                                                    } ?>>ePayment/EFT:
                                            credit to Chase account</option>
                                        <option value="Check: snail mailed to the UCB office" <?php if ($rows["payment_method_new"] == "Check: snail mailed to the UCB office") {
                                                                                                        echo " selected ";
                                                                                                    } ?>>Check: snail
                                            mailed to the UCB office</option>
                                    </select>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="display_table">
                                    ...
                                    <input type="hidden" name="vendors_dd" name="vendors_dd" value="<?php echo $_REQUEST["
                                        vendors_dd"]; ?>">
                                    <input type="hidden" name="comp_sel" name="comp_sel" value="<?php echo $_REQUEST["
                                        comp_sel"]; ?>">
                            ...
                            <tr>
                                ...
                                <td class="display_table">
                                    <input type="text" name="vendor_payment_log_notes" id="vendor_payment_log_notes"
                    ...
                    <table width="300px">
                        ...
                        <tr>
                            ...
                            <td class="display_table" width="150px">
                                <span id='view_made_payment<?php echo  $unique_count; ?>'>
                                    <?php echo ($rows['made_payment'] == 1) ? 'Yes' : 'No'; ?>
                                </span>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td class="display_table">Payment proof file:</td>
                            <td class="display_table">
                                <span id='view_payment_proof_file<?php echo  $unique_count; ?>'>
    ...
    <?php
        ...
        $MGarray[] = array(
            ...
            'payment_method_new' => $rows["payment_method_new"],
    ...
    <tr>
        <td class="display_table">
            <?php echo $MGArraytmp["vendor_name"]; ?>
        </td>
        <td class="display_table"><a target="_blank"
                href="viewCompany.php?ID=<?php echo $MGArraytmp[" b2bid"];
                                                                                        ?>&proc=View&searchcrit=&show=watertransactions&rec_type=Manufacturer">
                <?php echo $MGArraytmp["nickname"]; ?>
            </a></td>
        <td class="display_table">
        ...
        <td class="display_table">
            <?php if ($MGArraytmp["invoice_date"] != "") {
        ...
        <td class="display_table">$
            <?php echo number_format($MGArraytmp["amt"], 2); ?>
        </td>
        ...
        <td class="display_table">
            <?php echo $MGArraytmp["payment_method_new"]; ?>
        </td>
        <td class="display_table">
            <?php echo $MGArraytmp["paid_date"]; ?>
        </td>
        <td class="display_table">
        ...
        <td class="display_table">
            <?php
                    if ($MGArraytmp["made_payment"] == "" && $MGArraytmp["payment_method_new"] == "") {
                    ?>
            <form name="frmEditVendrRptLinkpg" method="post" action="editVendrRptLinkpg.php"
                ...
                <table>
                    <tr>
                        ...
                        <td class="display_table">Payment Method:</td>
                        <td class="display_table">
                            <input type="text" name="payment_method-<?php echo  $row; ?>" id="payment_method_new"
                                value=" ">
                        </td>
                ...
                <a class="btnEdit"
                    id="btnEditSectionOpen_<?php
                                                                        echo  $MGArraytmp["invoice_number"]; ?><?php
                                                                                                                echo $MGArraytmp["transid"]; ?>"
                    onclick="editSectionOpen('<?php
                                                                                                                                                                            echo
                                                                                                                                                                            $MGArraytmp["invoice_number"]; ?>
                    <?php echo $MGArraytmp["transid"] ?>')">Edit
                </a>
                            ...
                            <tr>
                                ...
                                <td class="display_table">
                                    <input type="text" name="payment_method-<?php echo  $row; ?>" id="payment_method"
                                        value="<?php echo  $MGArraytmp["payment_method_new"] ?>">
                                </td>
                                ...
                                <td class="display_table">
                                    ...
                                    <input type="hidden" name="hdnWatrTrnstnId-<?php echo  $row; ?>"
                                        value="<?php echo $MGArraytmp[" transid"] ?>">
                                    <input type="hidden" name="hdnvendrId-<?php echo  $row; ?>" value="<?php echo $MGArraytmp["
                                        vendor_id"] ?>">
                                    <input type="hidden" name="hdnInvcNo-<?php echo  $row; ?>" value="<?php echo $MGArraytmp["
                                        invoice_number"] ?>">
                                </td>
